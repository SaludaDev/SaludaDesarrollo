...
<button class="btn btn-default btn-smsaludaclinicasecho $Especialista['Color_Pago'];?>"><?php echo $Especialista["Estatus_pago"]; ?></button>
</div>
</div>
<!-- Basic dropdown -->
	 </td>
...
<?php endif;?>
 ...
 <script>
  	$(".btn-edit1").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludaclinicas.com/Enfermeria2/Modales/ContactoPaciente.php","id="+id,function(data){
              $("#form-edit").html(data);
      ...
      $(".btn-edit2").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludaclinicas.com/Enfermeria2/Modales/AgendaSignosVitalIndex.php","id="+id,function(data){
              $("#form-edit").html(data);
