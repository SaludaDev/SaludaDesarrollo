...
$Folio_Paciente =  $conn -> real_escape_string(htmlentities(strip_tags(Trim($_POST['folioo']))));
$Nombre_Paciente =  $conn -> real_escape_string(htmlentities(strip_tags(Trim($_POST['nombress']))));
$Edad =  $conn -> real_escape_string(htmlentities(strip_tags(Trim($_POST['edadd']))));
$Sexo =  $conn -> real_escape_string(htmlentities(strip_tags(Trim($_POST['sexoo']))));
$Telefono =  $conn -> real_escape_string(htmlentities(strip_tags(Trim($_POST['tele']))));
$Correo =  $conn -> real_escape_string(htmlentities(strip_tags(Trim($_POST['correoo']))));
