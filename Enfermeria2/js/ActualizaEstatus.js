$('document').ready(function($){
    $("#datap").hide();
      ...
      function submitForm() {		
          ...
          $.ajax({				
              type : 'POST',
              url: "Consultas/ModificaAgenda.php",
              data: {
          id:$('#id').val(),
          estatuscitagenda:$('#estatuscitagenda').val(),
          coloragenda:$('#coloragenda').val(),
              ...
              success: function(dataResult){
                  ...
                  if(dataResult.statusCode==200){
                    ...
                    $("#ConfirmacionCorrecta").modal("show")	
                  
                       $("#submit").html("Confirmado <i class='fas fa-check'></i>");	
                         $("#submit").attr('disabled','disabled');
                         $("#ConfPac").hide();
                         $("#TituloModal").html("Captura de signos vitales");
                         $("#datap").show();
                         $("#ConfirmacionCorrecta").modal("hide")	
                    ...
                    $("#submit").html(" Confirmar datos <i class='fas fa-user-check'></i>");	
                   
                    $("#ConfirmacionErronea").modal("show")	
