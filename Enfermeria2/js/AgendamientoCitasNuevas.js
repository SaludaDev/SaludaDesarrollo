$('document').ready(function($){
    ...
    $("#AgendaNuevoPaciente").validate({
        rules: {
           ...
           AgendarCitaDeEspecialistasNuevaVersion:{
               required:true,
           },
           Medico:{
               required:true,
   ...
   // hide messages 
    ...
    function submitForm() {		
		...
		$.ajax({				
			type : 'POST',
            url: "Consultas/GuardaCitaPacienteNuevoVersion.php",
            data: $('#AgendaNuevoPaciente').serialize(),
            cache: false,
            beforeSend: function(){	
            ...
            success: function(dataResult){
                ...
                setTimeout(function(){ 
                    $("#submit_Age").html("Guardar <i class='fas fa-save'></i>");
                                            ...
                                            $("#AgendarCitaDeEspecialistasNuevaVersion").removeClass("in");
                                            $(".modal-backdrop").remove();
                                            $("#AgendarCitaDeEspecialistasNuevaVersion").hide();
                                            $('#Exito').modal('toggle'); 
                                            $("#AgendaNuevoPaciente")[0].reset();
