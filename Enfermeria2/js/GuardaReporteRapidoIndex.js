$('document').ready(function ($) {
    ...
    function submitForm() {
      ...
      $.ajax({
        type: 'POST',
        url: "Consultas/ReporteRapido.php",
        data: $('#ReporteExpress').serialize(),
        cache: false,
        beforeSend: function () {
        ...
        success: function (dataResult) {
          ...
          if (dataResult.statusCode == 250) {
            ...
            $("#ReporteExpress")[0].reset();
            $("#ReporteRapidoModal").removeClass("in");
            $(".modal-backdrop").remove();
            $("#ReporteRapidoModal").hide();
