...
<head>
  ...
  <title>Reporte de incidencias | <?php echo $row['ID_H_O_D'] ?> </title>
...
<div class="card text-center">
  <div class="card-header" style="background-color:#33b5e5 !important;color: white;">
    Reporte rapido de incidencia
  </div>

  <div>
    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#ReporteRapidoModal" class="btn btn-default">
      Reportar<i class="fas fa-calendar-plus"></i>
    </button>
  </div>
...
<script src="js/ReporteIncidenciaRapida.js"></script>

<script src="js/GuardaReporteRapido.js"></script>
<!-- Bootstrap -->
