    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="https://controlconsulta.com/Enfermeria2/ListadoDataPacientes" class="nav-link">
          ...
          <li class="nav-item">
            <a href="https://controlconsulta.com/Enfermeria2/AgendamientoDeCitasV3" class="nav-link">
          ...
          <li class="nav-item">
            <a href="https://controlconsulta.com/Enfermeria2/CancelacionesV2" class="nav-link">
        ...
        <li class="nav-item has-treeview">
         ...
         Incidencia / Reportes
            ...
            <ul class="nav nav-treeview">
            <li class="nav-item">
            <a href="https://controlconsulta.com/Enfermeria2/ReporteRapido" class="nav-link">
...
window.location.replace('https://controlconsulta.com/Enfermeria/Cierre'); 
