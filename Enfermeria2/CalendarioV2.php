...
$consulta_eventos = "SELECT AgendaCitas_EspecialistasV3.ID_Agenda_Especialista,AgendaCitas_EspecialistasV3.Fk_Especialidad,
...
AgendaCitas_EspecialistasV3.Color_Seguimiento,AgendaCitas_EspecialistasV3.ID_H_O_D,AgendaCitas_EspecialistasV3.Color_Calendario,AgendaCitas_EspecialistasV3.Nombre_Paciente,
...
AgendaCitas_EspecialistasV3.Fk_Hora = Horarios_Citas_especialistasV2.ID_Horario AND  AgendaCitas_EspecialistasV3.Fk_Sucursal='".$row['Fk_Sucursal']."' AND
AgendaCitas_EspecialistasV3.Fk_Costo =  Costos_EspecialistasV2.ID_Costo_Esp AND
AgendaCitas_EspecialistasV3.ID_H_O_D='".$row['ID_H_O_D']."'";
