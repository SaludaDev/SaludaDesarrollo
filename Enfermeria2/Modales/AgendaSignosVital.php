...
<div class="row">
  ...
  <input type="date" class="form-control" value="<? echo $datapacientes->Fecha_Nacimiento; ?>" readonly onchange="calculaedad()" id="fechaNac" aria-describedby="basic-addon1">
</div>
    </div>
    <div class="col">
...
<input type="text" class="form-control" name="TA" readonly  value="       /">
  ...
  <input type="text" class="form-control" value="<? echo $datapacientes->Nombre_Especialidad; ?>" readonly name="Motivo" id="motivo" aria-describedby="basic-addon1">
</div>
<label for="motivo" class="error">
  ...
  <input type="text" class="form-control" readonly value="<? echo $datapacientes->Nombre_Apellidos; ?>"  name="Doctor" id="doctor" aria-describedby="basic-addon1">
