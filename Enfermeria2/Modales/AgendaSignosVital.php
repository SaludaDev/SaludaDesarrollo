    ...
    <div class="row">
      <div class="col">
        ...
        <div class="input-group mb-3">
          ...
          <input type="date" class="form-control" value="<?php echo $datapacientes->Fecha_Nacimiento; ?>" readonly onchange="calculaedad()" id="fechaNac" aria-describedby="basic-addon1">
        </div>
      </div>
      <div class="col">
    ...
    <div class="row">
      <div class="col">
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control" value="<?php echo $datapacientes->Nombre_Especialidad; ?>" readonly name="Motivo" id="motivo" aria-describedby="basic-addon1">
        </div>
      ...
      <div class="col">
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control" readonly value="<?php echo $datapacientes->Nombre_Apellidos; ?>" name="Doctor" id="doctor" aria-describedby="basic-addon1">
