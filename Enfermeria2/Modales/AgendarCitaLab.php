                    ...
                    <ul class="list-group">
                      <li class="list-group-item">
                        <div class="form-row">
                          ...
                          <input type="text" class="form-control" name="Agendo[]" value="<?php echo $row['Nombre_Apellidos'] ?>" hidden readonly>

                          <input type="text" class="form-control" name="Sucursal[]" value="<?php echo $row['Fk_Sucursal'] ?>" hidden readonly>
