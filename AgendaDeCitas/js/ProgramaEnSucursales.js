$('document').ready(function($){
    ...
    $("#ProgramaEnSucursalesV1").validate({
    rules: {
           
      
            ProgramacionDeSucursalesModal:{
                required:true,
          } ,      Especialidad:{
            required:true,
      } ,     
    ...
    function submitForm() {	
        ...
        $.ajax({				
            type : 'POST',
            url: "Consultas/ProgramacionEnSucursalesV1.php",
            data: $('#ProgramaEnSucursalesV1').serialize(),
            cache: false,
            beforeSend: function(){	
      ...
      success: function(dataResult){
        ...
        setTimeout(function(){ 
          ...
          $("#ProgramacionDeSucursalesModal").removeClass("in");
          $(".modal-backdrop").remove();
          $("#ProgramacionDeSucursalesModal").hide();
          $('#Exito').modal('toggle'); 
          $("#ProgramaEnSucursalesV1")[0].reset();
