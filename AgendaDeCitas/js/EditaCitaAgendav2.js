...
$('document').ready(function($){
    ...
    function submitForm() {		
        ...
        $.ajax({				
            type : 'POST',
            url: "Consultas/ActualizaDataCitaAgendaV2.php",
            data: {
                colorpago:$('#colorpago').val(),
                colorcita:$('#colorcita').val(),
                colorsegui:$('#colorsegui').val(),
                estatuspago:$('#estatuspago').val(),
                estatuscita:$('#estatuscita').val(),
                estatussigue:$('#estatussigue').val(),
        id:$('#id').val(),
