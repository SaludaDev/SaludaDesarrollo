...
$('document').ready(function($){
    $('#CancelaCompleto').hide();
   
       
    $("#Cancelaciones").validate({
        rules: {
            ID:{
                required:true,
             },
    ...
    function submitForm() {		
        ...
        $.ajax({				
            type : 'POST',
            url: "Consultas/ActualizaCancelacionV2.php",
            data: {
        ...
        id:$('#id').val(),
            ...
            success: function(dataResult){
             ...
             $('#AplicaCancel').modal('toggle'); 
             setTimeout(function(){ 
                $('#AplicaCancel').modal('hide'); 
            }, 2000); // abrir
             $("#Cancelaciones").hide();
             $('#CancelaCompleto').show();
