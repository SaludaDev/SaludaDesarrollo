$('document').ready(function ($) {
    ...
    function submitForm() {
        ...
        $.ajax({
            type: 'POST',
            url: "Consultas/ActualizaPaciente.php",
            data: $('#ActualizaPaciente').serialize(),
            cache: false,
            beforeSend: function () {
                $("#success").fadeOut();

                $("#submit_Age").html("Verificando datos... <span class='fa fa-refresh fa-spin' role='status' aria-hidden='true'></span>");
            ...
            success: function (dataResult) {
                ...
                if (dataResult.statusCode == 200) {
                    ...
                    $("#submit_Age").html("Enviado <i class='fas fa-check'></i>")
                    ...
                    $('#ExitoActualizap').modal('toggle');
                    setTimeout(function () {
                        $('#ExitoActualizap').modal('hide')
                    }, 2000); // abrir
                    CargaAltaPacientes();
                    ...
                    $("#submit_Age").html("Enviar <i class='fas fa-paper-plane'></i>")
