$("document").ready(function ($) {
  $("#AgendaEnSucursalA").validate({
    ...
    messages: {
      Folio: {
        required:
          "<i class='fas fa-exclamation-triangle' style='color:red'></i> Dato requerido ",
      },
  ...
  function submitForm() {
    $.ajax({
      type: "POST",
      url: "Consultas/AgendaCitaEnSucursalV1.php",
      data: $("#AgendaEnSucursalA").serialize(),
      cache: false,
      beforeSend: function () {
      ...
      success: function (dataResult) {
        ...
        if (dataResult.statusCode == 250) {
          ...
          $("#CitaEspecialistaDeSucursal").removeClass("in");
          $(".modal-backdrop").remove();
          $("#CitaEspecialistaDeSucursal").hide();
          $("#AgendaEnSucursalA")[0].reset();
