$('document').ready(function ($) {
    ...
    function submitForm() {
      ...
      $.ajax({
        type: 'POST',
        url: "Consultas/ProgramaFechasExt.php",
        data: $('#ProgramaFechas').serialize(),
        cache: false,
        beforeSend: function () {
        ...
        success: function(){
            ...
            $("#editModal").hide();
              ...
              $('#ActualizarEstadoFechas').trigger("click");
