...
<div class="card text-center">
  <div class="card-header" style="background-color: #80391e !important;color: white;">
    Costos vencidos al <?php echo FechaCastellano(date('d-m-Y H:i:s')); ?>  
  </div>
  <div >
...
<div id="CostosEspeciales"></div>
  ...
  include ("footer.php")?>
<!-- ./wrapper -->
<script src="js/ControlCostosVencidos.js"></script>
