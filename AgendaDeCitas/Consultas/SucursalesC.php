...
$user_id=null;
$sql1="SELECT * FROM Sucursales_CampañasV2 WHERE Estatus_Sucursal = 'Vigente' AND ID_H_O_D ='".$row['ID_H_O_D']."'";
...
<tr>
  ...
  <td><button class="btn btn-default btn-sm" style="<?echo $Sucursales['Color_Sucursal'];?>"><?php echo $Sucursales["Estatus_Sucursal"]; ?></button></td>
	...
	<td>
		<button data-id="<?php echo $Sucursales["ID_SucursalC"];?>" class="btn-edit btn btn-danger"><i class="fas fa-ban"></i></button></td>
...
<?php endif;?>
  ...
  <script>
  	$(".btn-edit").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/ControldecitasV2/Modales/EditaSucursalC.php","id="+id,function(data){
  			$("#form-edit").html(data);
  		});
