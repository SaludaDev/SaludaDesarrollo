...
function fechaCastellano ($fecha) {
  ...
  $meses_ES = array("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre");
	...
	$medicos = $conn->prepare("SELECT * FROM Fechas_EspecialistasExt WHERE 	FK_Especialista = '$medico' and Fecha_Disponibilidad >= CURDATE() ORDER BY Fecha_Disponibilidad ") or die(mysqli_error());
