...
$FK_Medico=$conn -> real_escape_string(htmlentities(strip_tags(trim(ucwords(strtolower($_POST['Medico']))))));
...
$sql = "SELECT FK_Medico,Fk_Sucursal,Tipo_Programacion,	Fecha_Inicio,Fecha_Fin,Hora_inicio,Hora_Fin,Intervalo,Estatus,ProgramadoPor FROM Programacion_Medicos_Sucursales
...
$sql = "INSERT INTO `Programacion_Medicos_Sucursales`(`FK_Medico`, `Fk_Sucursal`, `Tipo_Programacion`, `Fecha_Inicio`, `Fecha_Fin`, `Hora_inicio`, 
