...
FROM EspecialidadesV2,Sucursales_CampañasV2 WHERE EspecialidadesV2.Fk_Sucursal = Sucursales_CampañasV2.ID_SucursalC AND EspecialidadesV2.Estatus_Especialidad='Vigente'
...
<tr>
	...
	<td><button class="btn btn-default btn-sm" style="<?php echo $Especialidades['Codigocolor'];?>"><?php echo $Especialidades["Estatus_Especialidad"]; ?></button></td>
...
$('.modal').on('hidden.bs.modal', function (e) {
  modal_lv--
  	...
  	$(".btn-edit").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludaclinicas.com/ControldecitasV2/Modales/EditaEspecialidad.php","id="+id,function(data){
			  $("#form-edit").html(data);
