...
$AgregadoPor= $conn -> real_escape_string(htmlentities(strip_tags(Trim($_POST['Usuario']))));
    ...
    $insert = $conn->query("INSERT  Horarios_Citas_especialistasV2 (Horario_Disponibilidad,ID_H_O_D,FK_Especialista,Fk_Fecha,Estatus_Horario,CodigoColorHo,AgregadoPor) VALUES 
	('".$val."','".$ID_H_O_D."','".$FK_Especialista."','".$Fk_Fecha."','".$Estatus_Horario."','".$CodigoColorHo."','".$AgregadoPor."')");
    }
