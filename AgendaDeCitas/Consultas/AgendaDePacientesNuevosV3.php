...
AgendaCitas_EspecialistasV3.ID_H_O_D='" . $row['ID_H_O_D'] . "' order by AgendaCitas_EspecialistasV3.ID_Agenda_Especialista DESC";
      ...
      <table id="Campanas" class="table table-hover">
        ...
        <?php while ($Especialista = $query->fetch_array()) : ?>
          <tr>
            ...
            <td>
              <!-- Basic dropdown -->
              <button class="btn btn-info dropdown-toggle " type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-info-circle"></i></button>
            ...
            <td>
              ...
              <div class="dropdown-menu">
                <a data-id="<?php echo $Especialista["ID_Agenda_Especialista"]; ?>" class="btn-edit2 dropdown-item">Cambio de estado de cita <i class="fas fa-id-card-alt" aria-hidden="true"></i></a>
                <a data-id="<?php echo $Especialista["ID_Agenda_Especialista"]; ?>" class="btn-edit3 dropdown-item">Cancelacion <i class="fas fa-id-card-alt" aria-hidden="true"></i></a>
