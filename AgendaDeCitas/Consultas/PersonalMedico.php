...
<script>
  	$(".btn-AsigSucursal").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludaclinicas.com/AgendaDeCitas/Modales/AsignaAlEspecialistaEnSucursal.php","id="+id,function(data){
  			$("#form-edit").html(data);
    ...
    $(".btn-edit2").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludaclinicas.com/AdministracionPOS/Modales/HistorialSaldos.php","id="+id,function(data){
              $("#form-edit").html(data);
