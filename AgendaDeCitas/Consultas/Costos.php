...
Costos_EspecialistasV2.FK_Especialista = EspecialistasV2.ID_Especialista AND Costos_EspecialistasV2.Estatus ='Vigente' AND Costos_EspecialistasV2.ID_H_O_D='".$row['ID_H_O_D']."'";
...
<a data-id="<?php echo $Costo["ID_Costo_Esp"];?>" class="btn-edit2 dropdown-item" >Detalles costo <i class="fas fa-pencil-alt"></i></a>
...
$('.modal').on('hidden.bs.modal', function (e) {
  modal_lv--
  	...
  	$(".btn-edit").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/ControldecitasV2/Modales/EditaCosto.php","id="+id,function(data){
			  $("#form-edit").html(data);
