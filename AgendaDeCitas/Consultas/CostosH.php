...
Costos_Especialistas.FK_Especialista = Especialistas.ID_Especialista  AND Costos_Especialistas.ID_H_O_D='".$row['ID_H_O_D']."'";
...
<tr>
	...
	<td><button class="<?php echo $Costo['Codigocolor'];?>"><?php echo $Costo["Estatus"]; ?></button></td>
