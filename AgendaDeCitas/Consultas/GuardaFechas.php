...
$AgregadoPor	= $conn -> real_escape_string(htmlentities(strip_tags(Trim($_POST['Usuario']))));   
    ...
    $insert = $conn->query("INSERT  Fechas_EspecialistasV2 (Fecha_Disponibilidad,ID_H_O_D,FK_Especialista,Estatus_fecha,CodigoColorFe,AgregadoPor) VALUES 
	('".$val."','".$ID_H_O_D."','".$FK_Especialista."','".$Estatus_fecha."','".$CodigoColorFe."','".$AgregadoPor."')");
}
