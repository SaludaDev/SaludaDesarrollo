...
Horarios_Citas_especialistasV2.FK_Especialista = EspecialistasV2.ID_Especialista AND Horarios_Citas_especialistasV2.Estatus_Horario='Vencido'
...
<?php endif;?>
  ...
  <script>
  	$(".btn-edit").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludaclinicas.com/Controldecitas/Modales/EditaHorario.php","id="+id,function(data){
  			$("#form-edit").html(data);
  		});
