...
$meses_ES = array("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre");
  ...
  return $nombredia." ".$numeroDia." de ".$nombreMes." de ".$anio;
	...
	$medicos = $conn->prepare("SELECT * FROM Fechas_EspecialistasV2 WHERE Estatus_fecha='Vigente'and Fecha_Disponibilidad - INTERVAL 30 DAY AND NOW() AND FK_Especialista = '$medico'") or die(mysqli_error());
