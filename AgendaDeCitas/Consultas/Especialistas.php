...
EspecialidadesV2.ID_Especialidad,EspecialidadesV2.Nombre_Especialidad,Sucursales_CampañasV2.ID_SucursalC, Sucursales_CampañasV2.Nombre_Sucursal FROM EspecialistasV2,EspecialidadesV2,Sucursales_CampañasV2
 ...
 AND EspecialistasV2.Estatus_Especialista='Vigente' AND EspecialistasV2.ID_H_O_D='".$row['ID_H_O_D']."'";
...
<a data-id="<?php echo $Especialista["ID_Especialista"];?>" class="btn-edit dropdown-item" >Cambiar vigencia <i class="fas fa-ban"></i></a>
<a data-id="<?php echo $Especialista["ID_Especialista"];?>" class="btn-edit3 dropdown-item" >Editar datos <i class="fas fa-pencil-alt"></i></a>
  <a data-id="<?php echo $Especialista["ID_Especialista"];?>" class="btn-edit2 dropdown-item" >Detalles <i class="fas fa-info-circle"></i></a>
...
<?php else:?>
	<h3 class="alert alert-warning"> 	No se encontraron especialistasV2 <i class="fas fa-exclamation-circle"></i> </h3>
