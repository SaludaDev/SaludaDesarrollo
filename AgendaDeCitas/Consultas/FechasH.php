...
Fechas_Especialistas.FK_Especialista = Especialistas.ID_Especialista  AND 
...
<tr>
	...
	<td><button class="<?php echo $Fecha['CodigoColorFe'];?>"><?php echo $Fecha["Estatus_fecha"]; ?></button></td>
...
<?php endif;?>
  ...
  <script>
  	$(".btn-edit").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludaclinicas.com/Controldecitas/Modales/EditaFechaH.php","id="+id,function(data){
  			$("#form-edit").html(data);
  		});
