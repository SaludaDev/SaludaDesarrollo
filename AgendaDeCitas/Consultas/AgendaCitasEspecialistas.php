  ...
  <div class="table-responsive">
    <table id="AgendaCitasEspecialistas" class="table">
      ...
      <?php while ($AgendaCitasEsp = $query->fetch_array()) : ?>
        <tr>
          <td><?php echo $AgendaCitasEsp["ID_Agenda_Especialista"]; ?></td>
          <td style="width:200px;"><?php echo $AgendaCitasEsp["Nombre_Especialidad"]; ?> - <?php echo $AgendaCitasEsp["Nombre_Apellidos"]; ?></td>
          <td style="width:200px;"><?php echo fechaCastellano($AgendaCitasEsp["Fecha_Cita"]); ?> - <?php echo date('h:i A', strtotime($AgendaCitasEsp["Hora_Cita"])); ?></td>
          <td><?php echo $AgendaCitasEsp["Nombre_Paciente"]; ?></td>
          <td><?php echo $AgendaCitasEsp["Seguimiento"]; ?></td>
          <td><?php echo $AgendaCitasEsp["Estatus_pago"]; ?></td>
          <td><?php echo $AgendaCitasEsp["Estatus_cita"]; ?></td>



          <td style="width:200px;">
          <td><a class="btn btn-success" href="https://api.whatsapp.com/send?phone=+52<?php echo $row['Telefono']; ?> &text=Hola!%20Quiero%20generar%20mas%20ventas!" target="_blank"><span class="fab fa-whatsapp"></span><span class="hidden-xs"></span></a></td>
          ...
          <script>
            $("#del2-" + <?php echo $AgendaCitasEsp["ID_Camp_Esp"]; ?>).click(function(e) {
              ...
              $("#Celimina").click(function() {
                $.post("https://saludaclinicas.com/Controldecitas/Consultas/EliminarCampana.php", "id=" + <?php echo $AgendaCitasEsp["ID_Agenda_Especialista"]; ?>, function(data) {
...
<script>
  $(".btn-edit").click(function() {
    id = $(this).data("id");
    $.post("https://saludaclinicas.com/Controldecitas/Modales/EditaCampana.php", "id=" + id, function(data) {
      $("#form-edit").html(data);
    });
