      ...
      <div class="modal-body">
        <div class="text-center">
          <form enctype="multipart/form-data" id="AgregaEmpleados">
            ...
            <div class="row">
              <div class="col">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control " value="Call Center" aria-describedby="basic-addon1">
            ...
            <input type="number" class="form-control" name="usuario" id="usuario" hidden readonly value="14">
