      ...
      <div class="modal fade bd-example-modal-xl" id="FiltroCitasRevaloraciones" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
 ...
 <form  method="POST" action="BusquedaDeAgendaPorMes">
