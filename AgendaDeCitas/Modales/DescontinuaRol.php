...
<div class="form-group">
  ...
  <input type="text" class="form-control " name="ActEstado" id="actestado" hidden value="1" aria-describedby="basic-addon1" maxlength="60">
    ...
    <input type="text" class="form-control"  name="AgregaActs" id="agregaacts"  readonly value=" <?echo $row['Nombre_Apellidos']?>">
    <input type="text" class="form-control"  name="SistemaActs" id="sistemaacts"  readonly value=" <?echo $row['Nombre_rol']?>">
<input type="hidden" name="ids" id="ids" value="<?php echo $Especialistas->ID_rol; ?>">
