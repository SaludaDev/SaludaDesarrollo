...
<?php if ($Especialidades != null) : ?>
  ...
  <a class="btn btn-success" style="display:none;" id="Envio" href="https://api.whatsapp.com/send?phone=+52<?php echo $Especialidades->Telefono; ?>&text=¡Hola,<?php echo $Especialidades->Nombre_Paciente; ?>! Te contactamos de las clínicas +Doctor consulta para la confirmación para su cita el día *<?php echo FechaCastellano($Especialidades->Fecha_Disponibilidad) ?>  EN HORARIO DE <?php echo date('h:i A', strtotime(($Especialidades->Horario_Disponibilidad))); ?>* Te esperamos en nuestra clínica de <?php echo $Especialidades->Nombre_Sucursal; ?>" target="_blank"><span class="fab fa-whatsapp"></span><span class="hidden-xs"></span></a>
