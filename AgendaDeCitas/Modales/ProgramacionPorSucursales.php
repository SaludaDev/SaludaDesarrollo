...
<div class="modal fade" id="ProgramacionDeSucursalesModal" tabindex="-1" role="dialog" aria-labelledby="newModalLabel" aria-hidden="true">
<div class="modal-dialog  modal-lg modal-notify modal-primary">
 ...
 <form action="javascript:void(0)" method="post" id="ProgramaEnSucursalesV1">
...
<label for="exampleFormControlInput1">Fecha <span class="text-danger">*</span></label>
  ...
  <input type="date" class="form-control " hidden value="<?php echo $fechaActual?>" name="" id="fechapordiafin"  >
    </div><label for="nombreprod" class="error">
    </div>
