...
<div class="modal fade" id="AltaEmpleado" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="overflow-y: scroll;">
  <div class="modal-dialog modal-lg modal-notify modal-success" role="document">
    <!--Content-->
    <div class="modal-content">
      <!--Header-->
      <div class="modal-header">
        <p class="heading lead">Alta de nuevo medico</p>
          ...
          <form enctype="multipart/form-data" id="AgregaEmpleados">
            ...
            <div class="row">
              ...
              <div class="col">
                ...
                </div><label for="telefono" class="error">
              </div>
            </div>
            <label for="">
              <h3> Datos del empleado para el uso del sistema</h3>
            </label>
            <div class="row">
              <div class="col">
              ...
              <div class="col">
                ...
                </div><label for="password" class="error">
              </div>
            </div>
            <div class="row">
              <div class="col">
              ...
              <div class="col">
                <label for="exampleFormControlInput1">Rol de médico </label>
                <div class="input-group mb-3">
                  <div class="input-group-prepend"> <span class="input-group-text" id="Tarjeta"><i class="fas fa-receipt"></i></span>
                  </div>
                  <select id="usuario" class="form-control" name="usuario">
                    <option value="">Seleccione :</option>
                    <?php
                    $query = $conn->query("SELECT ID_rol,Nombre_rol FROM Roles_Puestos WHERE Nombre_rol LIKE 'Me%' or Nombre_rol LIKE 'Mé%' AND  ID_H_O_D='" . $row['ID_H_O_D'] . "'");
                    while ($valores = mysqli_fetch_array($query)) {
              ...
              <div class="col">
                ...
                </div><label for="file" class="error">
              </div>
            </div>
