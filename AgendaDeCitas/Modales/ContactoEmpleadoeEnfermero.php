...
$user_id = null;
$sql1 = "SELECT * FROM `Personal_Enfermeria` WHERE Enfermero_ID = " . $_POST["id"];
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col">
        ...
        <? echo $Especialidades->Nombre_Apellidos; ?>
      </div>
      ...
      <div class="col"> <label for="exampleFormControlInput1">Whatsapp</label> <br>
        ...
        <a href="https://api.whatsapp.com/send/?phone=%2B52<? echo $Especialidades->Telefono; ?>"> <? echo $Especialidades->Telefono; ?> </a>
      </div>
      <div class="col"> <label for="exampleFormControlInput1">Correo</label> <br>
        <i class="fas fa-envelope-square"></i> <br>
        <a href="mailto:<? echo $Especialidades->Correo_Electronico; ?>"> <? echo $Especialidades->Correo_Electronico; ?></a>
      </div>
