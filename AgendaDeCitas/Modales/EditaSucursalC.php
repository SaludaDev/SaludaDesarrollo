...
$user_id=null;
$sql1= "SELECT * FROM Sucursales_CampañasV2 WHERE Estatus_Sucursal = 'Vigente' AND ID_SucursalC = ".$_POST["id"];
...
<form action="javascript:void(0)" method="post" id="VigenciaSucursal" >
...
<script src="js/EditaSucursalC.js"></script>
