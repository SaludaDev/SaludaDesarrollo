...
<input type="hidden" name="idreactiva" id="idreactiva" value="<?php echo $Especialistas->PersonalAgenda_ID; ?>">
<button type="submit"  id="submit"  class="btn btn-primary">Confirmar reactivacion <i class="fas fa-check"></i></button>
                          
</form>
<script src="js/ReactivaCallCenter.js"></script>
