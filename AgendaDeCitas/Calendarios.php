...
AND Horarios_Citas_Sucursales.ID_Horario = AgendaCitas_EspecialistasSucursales.Hora AND AgendaCitas_EspecialistasSucursales.ID_H_O_D='".$row['ID_H_O_D']."'";
;
...
AgendaCitas_EspecialistasExt.Hora = Horarios_Citas_Ext.ID_Horario AND AgendaCitas_EspecialistasExt.ID_H_O_D ='".$row['ID_H_O_D']."'";
;
