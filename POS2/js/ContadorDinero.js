         ...
         document.getElementById("resultadocinco").value = f.toFixed(2);
          ...
          document.getElementById("resultadocincuentac").value = p.toFixed(2);
            ...
            document.getElementById("resultadoveintec").value = q.toFixed(2);
              ...
              total= (parseFloat(r)) + (parseFloat(l)) + (parseFloat(a)) + (parseFloat(b)) + (parseFloat(c)) + (parseFloat(z)) + (parseFloat(d)) + (parseFloat(f)) + (parseFloat(g)) + (parseFloat(h)) + (parseFloat(p)) + (parseFloat(q)) + (parseFloat(w)); 
              document.getElementById("resultado").value = total.toFixed(2);
              
              document.getElementById("resultadoticket").value = total.toFixed(2);
