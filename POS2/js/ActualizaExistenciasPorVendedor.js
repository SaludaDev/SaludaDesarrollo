$('document').ready(function($){
    ...
    $("#RegistrosPorActualizar").validate({
        rules: {
    ...
    function submitForm() {		
        ...
        $.ajax({				
            type : 'POST',
            url: "Consultas/RegistrosPorActualizar.php",
            data: $('#RegistrosPorActualizar').serialize(),
            cache: false,
            beforeSend: function(){	
                $("#success").fadeOut();
            ...
            success: function(dataResult){
                ...
                if(dataResult.statusCode==200){
                  ...
                  $("#RegistrosPorActualizar")[0].reset();
                  $("#ActualizaRegistros").removeClass("in");
                  $(".modal-backdrop").remove(); 
                  $("#ActualizaRegistros").hide();
