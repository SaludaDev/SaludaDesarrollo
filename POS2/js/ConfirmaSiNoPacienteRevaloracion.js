$('document').ready(function($) {
    ...
    $("#AsistenciaDelPaciente").validate({
        rules: {
            Colorpago: {
                required: true,
            },
    ...
    function submitForm() {
        ...
        $.ajax({
            type: "POST",
            url: "Consultas/ActualizaEstadoAsintenciaRevaloracion.php",
            data: $("#AsistenciaDelPaciente").serialize(),
            cache: false,
            beforeSend: function() {
                $("#success").fadeOut();
            ...
            success: function(dataResult) {
                ...
                if (dataResult.statusCode == 200) {
                    ...
                    $('#ExitoActualizaVisita').modal('toggle');
                    setTimeout(function() {
                        $('#ExitoActualizaVisita').modal('hide')
                    }, 2000); // abrir
