$('document').ready(function($){
    ...
    function submitForm() {		
        ...
        $.ajax({				
            type : 'POST',
            url: "Consultas/CambiaAsignacionCaja.php",
            data: $('#CambiaAsignacionCaja').serialize(),
            cache: false,
            beforeSend: function(){	
                $("#success").fadeOut();
            ...
            success: function(dataResult){
                ...
                if(dataResult.statusCode==200){
                  ...
                  $('#ExitoActualizaCambioCaja').modal('toggle'); 
                  setTimeout(function(){ 
                      $('#ExitoActualizaCambioCaja').modal('hide') 
                  }, 2000); // abrir
