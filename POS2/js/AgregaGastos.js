$('document').ready(function($){
    ...
    $("#AgregarGastoDeSucursal").validate({
		rules: {
    ...
    function submitForm() {	
        ...
        $.ajax({				
            type : 'POST',
            url: "Consultas/AgregarGastosDeSucursales.php",
            data: $('#AgregarGastoDeSucursal').serialize(),
            cache: false,
            beforeSend: function(){	
      ...
      success: function(dataResult){
        ...
        setTimeout(function(){ 
            $("#submit_registro").html("Guardar <i class='fas fa-save'></i>");
             ...
             $("#AgregarGastoDeSucursal")[0].reset();
             $("#AltaGastoCat").removeClass("in");
