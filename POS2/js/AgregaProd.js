$('document').ready(function ($) {
  ...
  $("#GeneraTicketClinica").hide();
  $("#GuardaReimpresionTicketClinica").hide();
   $("#ActualizaSaldoCredClinica").hide();
      ...
      function submitForm() {
        ...
        $.ajax({
          type: 'POST',
          url: "Consultas/AgregaCreditoProd.php",
          data: $('#AgregaCreditoProd').serialize(),
          cache: false,
          beforeSend: function () {
          ...
          success: function (dataResult) {
            ...
            if (dataResult.statusCode == 250) {
              ...
              $("#AgregaCreditoProd")[0].reset();
              $("#AperturaCreditClinica").removeClass("in");
              $(".modal-backdrop").remove();
              $("#AperturaCreditClinica").hide();
              ...
              $.ajax({				
                  type : 'POST',
                  url: "Consultas/ActualizaSaldoCredClinica.php",
                  data: $('#ActualizaSaldoCredClinica').serialize(),
                  cache: false,
                  beforeSend: function(){	
                      $("#success").fadeOut();
                  ...
                  success: function(dataResult){
                      ...
                      CargaCreditosClinicas();
                       //  Solucionar muestra de modal de exito
                             ...
                             $.ajax({				
                              type : 'POST',
                              url: "Consultas/ReimpresionesTicketsClinicas.php",
                              data: $('#GuardaReimpresionTicketClinica').serialize(), 
                              cache: false,
                              beforeSend: function(){	
                                  $("#success").fadeOut();
                              ...
                              success: function(dataResult){
                                  ...
                                  else if(dataResult.statusCode==901){
                                      alert("Error occured !");
