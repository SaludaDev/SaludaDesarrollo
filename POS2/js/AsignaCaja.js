$('document').ready(function($){
    ...
    function submitForm() {		
        ...
        $.ajax({				
            type : 'POST',
            url: "Consultas/AsignacionCaja.php",
            data: $('#AsignacionCaja').serialize(),
            cache: false,
            beforeSend: function(){	
                $("#success").fadeOut();
            ...
            success: function(dataResult){
                ...
                if(dataResult.statusCode==200){
                  ...
                  $('#ExitoActualizaCambioCajaElegida').modal('toggle'); 
                  setTimeout(function(){ 
                      $('#ExitoActualizaCambioCajaElegida').modal('hide') 
                  }, 2000); // abrir
