...
<div class="row">
  ...
  <input type="text" hidden class="form-control " readonly name="ExisteActual" id="existenciaactual"  aria-describedby="basic-addon1" value="<? echo $Especialistas->Existencias_R; ?>" >              
    </div><label for="maxe" class="error">
    </div>
    <div class="col">
    <label for="exampleFormControlInput1">Stock despues de traspaso<span class="text-danger">*</span></label>
    <div class="input-group mb-3">
  <div class="input-group-prepend">  <span class="input-group-text" id="Tarjeta"><i class="fas fa-at"></i></span>
  </div>
