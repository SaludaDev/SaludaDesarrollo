...
Traspasos_generados.Precio_Venta,Traspasos_generados.Precio_Compra, Traspasos_generados.Total_traspaso,Traspasos_generados.TotalVenta,Traspasos_generados.Existencias_R,
 ...
 Traspasos_generados,SucursalesCorre WHERE Traspasos_generados.Fk_sucursal = SucursalesCorre.ID_SucursalC AND Traspasos_generados.ID_Traspaso_Generado= $IdBusqueda";
...
<form enctype="multipart/form-data" id="GeneraTraspasoProductos">
  ...
  <input type="date" class="form-control " name="FechaAprox" id="fechaaprox"  > 
