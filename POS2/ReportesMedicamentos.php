...
<div class="card text-center">
  ...
  Agregar devoluciones<i class="fas fa-user-plus"></i>
</button>
</div>
...
<div id="CitasEnLaSucursal"></div>
 ...
 include ("Modales/AnexaDevolucion.php");
  include ("footer.php")?>

<script src="js/DevolucionesDeMedicamentos.js"></script>
<script src="js/GuardaDevoluciones.js"></script>
