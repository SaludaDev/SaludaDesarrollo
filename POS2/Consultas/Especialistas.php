...
Especialidades.ID_Especialidad,Especialidades.Nombre_Especialidad,Sucursales_Campañas.ID_SucursalC, Sucursales_Campañas.Nombre_Sucursal FROM Especialistas,Especialidades,Sucursales_Campañas
 WHERE Especialistas.Especialidad = Especialidades.ID_Especialidad AND Especialistas.Fk_Sucursal =Sucursales_Campañas.ID_SucursalC  
 AND Especialistas.Estatus_Especialista='Activo' AND Especialistas.ID_H_O_D='".$row['ID_H_O_D']."'";
...
<?php endif;?>
  ...
  <script>
  	$(".btn-edit").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/Controldecitas/Modales/EditaEspecialista.php","id="+id,function(data){
  			$("#form-edit").html(data);
  		});
