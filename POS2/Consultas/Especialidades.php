...
FROM Especialidades,Sucursales_Campañas WHERE Especialidades.Fk_Sucursal = Sucursales_Campañas.ID_SucursalC AND Especialidades.Estatus_Especialidad='Activo'
AND  Especialidades.ID_H_O_D='".$row['ID_H_O_D']."'";
...
<?php endif;?>
  ...
  <script>
  	$(".btn-edit").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/Controldecitas/Modales/EditaEspecialidad.php","id="+id,function(data){
  			$("#form-edit").html(data);
  		});
