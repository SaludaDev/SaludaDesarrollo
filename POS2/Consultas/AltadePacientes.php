...
<div class="dropdown-menu">
  <a data-id="<?php echo  $DataPacientes["ID_Data_Paciente"];?>" class="btn-edit2 dropdown-item" >Agendar cita <i class="fas fa-calendar-alt"></i></a>
...
<?php endif;?>
  ...
  <script>
  	...
  	$(".btn-edit2").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/POS2/Modales/AgendaNuevo.php","id="+id,function(data){
        $("#form-edit").html(data);
