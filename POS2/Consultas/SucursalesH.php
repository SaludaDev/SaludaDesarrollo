...
$user_id=null;
$sql1="SELECT * FROM Sucursales_Campañas WHERE ID_H_O_D ='".$row['ID_H_O_D']."'";
...
<?php endif;?>
  ...
  <script>
  	$(".btn-edit").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/Controldecitas/Modales/EditaSucursalH.php","id="+id,function(data){
  			$("#form-edit").html(data);
  		});
