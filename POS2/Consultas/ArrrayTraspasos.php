...
Traspasos_generados.Precio_Venta,Traspasos_generados.Precio_Compra, Traspasos_generados.Total_traspaso,Traspasos_generados.TotalVenta,Traspasos_generados.Existencias_R,
 ...
 AND Traspasos_generados.Estatus ='Generado'
 AND MONTH(Traspasos_generados.FechaEntrega) = MONTH(CURDATE()) AND YEAR(Traspasos_generados.FechaEntrega) = YEAR(CURDATE()) AND Traspasos_generados.Fk_SucDestino='".$row['Fk_Sucursal']."'"; 
