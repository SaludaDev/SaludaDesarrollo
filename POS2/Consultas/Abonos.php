...
AbonoCreditos_POS.Fk_Sucursal= SucursalesCorre.ID_SucursalC and AbonoCreditos_POS.Fk_Sucursal='".$row['Fk_Sucursal']."' AND AbonoCreditos_POS.ID_H_O_D ='".$row['ID_H_O_D']."'";
...
<a data-id="<?php echo  $Categorias["Fk_Folio_Credito"];?>" class="btn-edit dropdown-item" >Imprimir ticket <i class="fas fa-print"></i></a>
