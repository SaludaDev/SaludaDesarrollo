...
Ventas_POS.AgregadoEl,SucursalesCorre.ID_SucursalC,SucursalesCorre.Nombre_Sucursal,COUNT(Ventas_POS.Identificador_tipo) as cantidadserv,
Servicios_POS.Servicio_ID,Servicios_POS.Nom_Serv,SUM(Ventas_POS.Importe) as totaldeservicios FROM
 ...
 AND Ventas_POS.Fk_sucursal=SucursalesCorre.ID_SucursalC AND Ventas_POS.Fk_sucursal='".$row['Fk_Sucursal']."' AND Ventas_POS.ID_H_O_D ='".$row['ID_H_O_D']."' 
 AND Ventas_POS.AgregadoPor ='".$row['Nombre_Apellidos']."'
  GROUP by Servicios_POS.Servicio_ID,Ventas_POS.Fecha_venta,Ventas_POS.Turno";
