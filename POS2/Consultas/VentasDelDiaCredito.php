...
Ventas_POS.Nombre_Prod,Ventas_POS.Cantidad_Venta,Ventas_POS.Fk_sucursal,Ventas_POS.AgregadoPor,Ventas_POS.AgregadoEl,Ventas_POS.FormaDePago, Ventas_POS.Total_Venta,
Ventas_POS.Lote,Ventas_POS.ID_H_O_D,SucursalesCorre.ID_SucursalC,SucursalesCorre.Nombre_Sucursal FROM Ventas_POS,SucursalesCorre WHERE Ventas_POS.Fk_sucursal= SucursalesCorre.ID_SucursalC 
AND Ventas_POS.Fk_sucursal='".$row['Fk_Sucursal']."' AND Ventas_POS.AgregadoPor='".$row['Nombre_Apellidos']."' AND Ventas_POS.FormaDePago='Crédito Enfermería' AND Ventas_POS.ID_H_O_D ='".$row['ID_H_O_D']."'  GROUP BY (Ventas_POS.Folio_Ticket)";
...
<script>
    ...
    id = $(this).data("id");
    $.post("https://controlfarmacia.com/POS2/Modales/DesgloseTicketCreditoEnfermeria.php","id="+id,function(data){
...
$(".btn-Reimpresion").click(function(){
    id = $(this).data("id");
    $.post("https://controlfarmacia.com/POS2/Modales/ReimpresionTicketVentaCreditoEnfermeria.php","id="+id,function(data){
        $("#FormCancelacion").html(data);
