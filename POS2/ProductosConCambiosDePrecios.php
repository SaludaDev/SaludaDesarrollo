...
<head>
  ...
  <title>Productos con cambios de precios | <?echo $row['ID_H_O_D']?> <?echo $row['Nombre_Sucursal']?> </title>
...
<div class="card text-center">
  <div class="card-header" style="background-color:#2bbbad !important;color: white;">
    Productos con cambios de precio de <?echo $row['ID_H_O_D']?> al <?php echo FechaCastellano(date('d-m-Y H:i:s')); ?>  
  </div>
...
<!-- REQUIRED SCRIPTS -->
<script src="js/ControlDeCambiosDePrecios.js"></script>
