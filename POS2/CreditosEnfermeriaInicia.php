...
$NombreEnfermero=($_POST['NombreEnfemero']);
$Sucursal=($_POST['SucursalNombre']);
$ClaveSucursal=($_POST['SucursalClave']);
setcookie("Busquedainfinita", $ClaveSucursal, time() + 30*24*60*60);
...
<head>
  ...
  <title>Generar orden de surtido a enfermeria <?echo $row['ID_H_O_D']?> </title>
...
<div class="row">
    ...
    <label for="exampleFormControlInput1">Enfermero </label> <br>
    <div class="input-group mb-3">
  <div class="input-group-prepend">  <span class="input-group-text" id="Tarjeta2"><i class="fas fa-barcode"></i></span>
  <input type="text" name=""  id="" readonly class="form-control" value="<?echo $NombreEnfermero?>">
  <input type="text" name="" hidden  id="" class="form-control" value="<?echo $SucursalDestinoLetras?>">
  </div>
    ...
    <label for="exampleFormControlInput1">Fecha de surtido</label> <br>
    <div class="input-group mb-3">
  ...
  <label for="exampleFormControlInput1"># de orden</label> <br>
      <div class="input-group mb-3">
    <div class="input-group-prepend">  <span class="input-group-text" id="Tarjeta2"><i class="fas fa-money-check-alt"></i></span>
    </div>
    <input type="number" class="form-control " id="resultadocompras" name="resultadocompras[]" readonly  >
...
<div class="text-center">
   ...
   <input type="text" class="form-control "  hidden name="GeneradoPor[]" value="<?echo $row['Nombre_Apellidos']?>"readonly  >
      ...
      <input hidden readonly type="text" id="proveedor1vista1" placeholder="Nombres"/>
      <input hidden readonly type="text" id="proveedor2vista2" placeholder="Nombres"/>
      <input class="input-preciocompra form-control"  hidden type="text" id="preciodecompra" name="PrecioDeCompra[]" placeholder="Grado"/>
      <input hidden  class="form-control" readonly type="text" id="CodProcedimiento" name="CodProcedimiento[]" placeholder="Nombres"/>
  </form>    
