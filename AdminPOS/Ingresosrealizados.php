...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#RealizarIngresosin" class="btn btn-default">
  Ingresar Medicamentos  <i class="fas fa-prescription-bottle"></i>
</button>
...
<?php
  ...
  include("Modales/IngresosMedicamentos.php");
...
<script src="js/ControlIngresos.js"></script>
