...
<head>
  ...
  <title>Reportes de Electrocardiogramas   </title>
        ...
        buttons:[ 
			{
                ...
                title: 'registros de Electrocardiogramas del <?php echo $fecha1?> al <?php echo $fecha2?>',
...
<?php endif;?>
  ...
  <!-- Main Footer -->
<?php
 include ("Modales/BuscaPorFechaVentasElektros.php");
  include ("footer.php")?>
