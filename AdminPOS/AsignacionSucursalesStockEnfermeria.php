...
$sql1= "SELECT * FROM Productos_POS WHERE ID_Prod_POS = $IdBusqueda";
        ...
        <input type="text" class="form-control " hidden name="CodEnfermeria" id="asignaclaenfer" value="<? echo $Especialistas->Cod_Enfermeria; ?>">
...
<div class="row">
  ...
  <input type="date" class="form-control " id="aslote" name="AsFecha" value="<? echo $Especialistas->Fecha_Caducidad; ?>" >
  ...
  <input type="text" class="form-control " name="ASMinimo" id="asmine"  aria-describedby="basic-addon1" value="<? echo $Especialistas->Max_Existencia; ?>" >           
    </div><label for="mine" class="error">
    </div>
    <div class="col">
  ...
  <input type="text" class="form-control " name="AsMaximo" id="asmaxe"  aria-describedby="basic-addon1" value="<? echo $Especialistas->Min_Existencia; ?>" >           
    </div><label for="maxe" class="error">
    </div>
    </div>
