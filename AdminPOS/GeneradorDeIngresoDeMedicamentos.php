...
setcookie("Busquedainfinita", $SucursalDestino, time() + 30*24*60*60);
;
include "Consultas/Consultas.php";
include "Consultas/Sesion.php";
include "Consultas/AnalisisIndex.php";
include "Consultas/SumaDeTraspasos.php";
include "BusquedaProductosIngresos.php"
?>
<!DOCTYPE html>
<html lang="es">
<head>
        ...
        $(document).ready(function(){
            ...
            $(".addMore").click(function(){
                ...
                $(".selector-" + id + " #codbarra").autocomplete({
                  source: "Consultas/BusquedaProductosIngresos.php",
                        minLength: 2,
...
<form action="javascript:void(0)" method="post" id="Generamelostraspasos" >
  ...
  <button type="submit"   value="Guardar" class="btn btn-success">Ingresar productos <i class="fa-solid fa-arrow-right-arrow-left"></i></button>
...
<div class="row">
    ...
    <label for="exampleFormControlInput1">Sucursal destino</label> <br>
    <div class="input-group mb-3">
  <div class="input-group-prepend">  <span class="input-group-text" id="Tarjeta2"><i class="fas fa-barcode"></i></span>
  <input type="text" name="" hidden id="" readonly class="form-control" value="<?echo $SucursalDestino?>">
  <input type="text" name="" id="" class="form-control" value="<?echo $SucursalDestinoLetras?>">
  </div>
    ...
    <label for="exampleFormControlInput1">Fecha de entrega</label> <br>
    <div class="input-group mb-3">
...
<div class="text-center">
   ...
   <div class="col">     <label for="exampleFormControlInput1">Proveedor 1<span class="text-danger">*</span>   </label>   <input class="form-control" readonly type="text" id="proveedor1vista1" placeholder="Nombres"/></div>
   <div class="col">     <label for="exampleFormControlInput1">Proveedor 2 <span class="text-danger">*</span>   </label>   <input class="form-control" readonly type="text" id="proveedor2vista2" placeholder="Nombres"/></div>
