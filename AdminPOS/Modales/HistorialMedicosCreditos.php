...
$user_id=null;
$sql1= "SELECT * FROM `Medicos_Credit_POS_Audita` WHERE ID_H_O_D='".$row['ID_H_O_D']."' AND ID_Med_Cred = ".$_POST["id"];
...
<tr>
<td > <?php echo $Categorias["ID_Upd_Med_Cred"]; ?></td>
