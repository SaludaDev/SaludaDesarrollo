...
$(document).ready( function () {
    var printCounter = 0;
    $('#MovimientosCategorias').DataTable({
      "order": [[ 0, "desc" ]],
          ...
          buttons:[ 
			{
                ...
                title: 'Ediciones realizadas en categorias ',
...
<?php if($query->num_rows>0):?>
  <div class="text-center">
	...
	<table  id="MovimientosCategorias" class="table table-hover">
<thead>
...
<tr>
<td > <?php echo $Categorias["ID_Update"]; ?></td>
