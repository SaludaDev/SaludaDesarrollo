...
$(document).ready( function () {
    var printCounter = 0;
    $('#MovimientosServicios').DataTable({
      "order": [[ 0, "desc" ]],
...
$user_id=null;
$sql1= "SELECT * FROM Servicios_POS_Audita WHERE ID_H_O_D ='".$row['ID_H_O_D']."' AND Servicio_ID = ".$_POST["id"];
...
<?php if($query->num_rows>0):?>
  <div class="text-center">
	...
	<table  id="MovimientosServicios" class="table table-hover">
<thead>
...
<tr>
<td > <?php echo $Categorias["Audita_Serv_ID"]; ?></td>
