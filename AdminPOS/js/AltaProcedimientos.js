$('document').ready(function($){
    ...
    function submitForm() {		
        $.ajax({				
        type : 'POST',
        url: "Consultas/AgregaProcedimientos.php",
        data: $('#AgregaProcedimientos').serialize(),
        cache: false,
        beforeSend: function(){		
				$("#success").fadeOut();
            ...
            success: function(dataResult){
                ...
                setTimeout(function(){ 
                    $("#submit_registro").html("Guardar <i class='fas fa-save'></i>");
                     ...
                     $("#AgregaProcedimientos")[0].reset();
                     $("#AltaProcedimiento").removeClass("in");
                     $(".modal-backdrop").remove();
                     $("#AltaProcedimiento").hide();
