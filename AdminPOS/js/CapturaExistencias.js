$('document').ready(function($) {
    ...
    function submitForm() {
        ...
        $.ajax({
            type: 'POST',
            url: "Consultas/AgregaRegistroStock.php",
            data: $('#AgregaExistencias').serialize(),
            cache: false,
            beforeSend: function() {
            ...
            success: function(dataResult) {
                ...
                if (dataResult.statusCode == 250) {
                    ...
                    setTimeout(' window.location.href = "https://controlfarmacia.com/AdminPOS/AjusteDeInventarios"; ', 2000);
