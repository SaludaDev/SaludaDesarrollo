$('document').ready(function($){
    $("#EnviaActualizacionPrecios").hide();
      ...
      $("#EnviaActualizacionPrecios").validate({
          rules: {
      ...
      function submitForm() {		
          ...
          $.ajax({				
              type : 'POST',
              url: "Consultas/EnviaActualizacionProvStocks.php",
              data: $('#EnviaActualizacionPrecios').serialize(),
              cache: false,
              beforeSend: function(){	
                  $("#success").fadeOut();
