$('document').ready(function($){
    ...
    function submitForm() {	
        ...
        $.ajax({				
            type : 'POST',
            url: "Consultas/AltaMedicosCreditos.php",
            data: $('#AgregaMedCreditos').serialize(),
            cache: false,
            beforeSend: function(){	
      ...
      success: function(dataResult){
        ...
        setTimeout(function(){ 
            $("#submit_registro").html("Guardar <i class='fas fa-save'></i>");
             ...
             $("#AgregaMedCreditos")[0].reset();
             $("#AltaMedicosCreditos").removeClass("in");
             $(".modal-backdrop").remove();
             $("#AltaMedicosCreditos").hide();
