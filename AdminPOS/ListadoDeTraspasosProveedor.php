...
<div class="card text-center">
  ...
  <div >
  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#FiltroTraspasos" class="btn btn-default">
...
<?php
  ...
  include("Modales/RealizaNuevaOrdenTraspasoProveedor.php");
