...
$IdBusqueda=($_POST['SucursalProducto']);
$fecha1=($_POST['Fecha1Prod']);
$fecha2=($_POST['Fecha2Prod']);
$nombresucursalelegida=($_POST['nombresucursal']);
$CodBarraProducto=($_POST['ProductoBuscado']);
$sql1="SELECT Ventas_POS.Cod_Barra,Ventas_POS.Nombre_Prod,Ventas_POS.Fk_sucursal,Ventas_POS.Fecha_venta,Ventas_POS.FormaDePago,Ventas_POS.AgregadoPor, 
SucursalesCorre.ID_SucursalC,SucursalesCorre.Nombre_Sucursal,Stock_POS.Cod_Barra,Stock_POS.Fk_sucursal FROM Ventas_POS,SucursalesCorre,Stock_POS WHERE 
Ventas_POS.Fecha_venta BETWEEN '$fecha1' AND '$fecha2' AND Ventas_POS.Fk_sucursal= SucursalesCorre.ID_SucursalC AND Ventas_POS.Fk_sucursal='$IdBusqueda' AND 
Stock_POS.Fk_sucursal='$IdBusqueda' AND Ventas_POS.Cod_Barra = Stock_POS.Cod_Barra AND Ventas_POS.Cod_Barra ='$CodBarraProducto'"
?>
<!DOCTYPE html>
<html lang="es">
<head>
