...
Ventas_POS.Identificador_tipo = Servicios_POS.Servicio_ID AND Ventas_POS.Identificador_tipo=11 "
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<div class="card text-center">
  ...
  Datos de laboratorios  del <?php echo fechaCastellano($fecha1)?> al <?php echo fechaCastellano($fecha2)?>
  </div>
  <div >
        ...
        buttons:[ 
			{
                ...
                title: 'registros de rayos X del <?php echo $fecha1?> al <?php echo $fecha2?>',
...
<?php endif;?>
  ...
  <!-- Main Footer -->
<?php
 include ("Modales/BuscaPorFechaVentasRayosX.php");
  include ("footer.php")?>
