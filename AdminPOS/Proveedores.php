...
<div class="card text-center">
  ...
  <div >
  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#AltaProveedor" class="btn btn-default">
  Añadir nuevo proveedor <i class="fas fa-plus-square"></i>
</button>
</div>
</div>
