...
$IdBusqueda=($_POST['SucursalVendedor']);
$ElVendedor=($_POST['VendedorAFiltrar']);
$fecha1=($_POST['Fecha1Vendedor']);
$fecha2=($_POST['Fecha2Vendedor']);

$sql1="SELECT Ventas_POS.Turno,Ventas_POS.Fk_sucursal,SUM(Ventas_POS.Importe) as TotalGenerado,Ventas_POS.Fecha_venta,Ventas_POS.AgregadoPor,Ventas_POS.FormaDePago,
...
Fecha_venta BETWEEN '$fecha1'  AND '$fecha2' AND  Ventas_POS.Fk_sucursal='$IdBusqueda'  AND Ventas_POS.AgregadoPor='$ElVendedor' AND Ventas_POS.FormaDePago <>'Crédito Enfermería' 
GROUP BY Ventas_POS.AgregadoPor,Ventas_POS.Turno,SucursalesCorre.Nombre_Sucursal,Ventas_POS.Fecha_venta ORDER BY `Ventas_POS`.`Fecha_venta` asc"
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Estadisticas de ventas por fechas de sucursales</title>
...
<div class="card text-center">
  ...
  Datos de venta  del <?echo fechaCastellano($fecha1)?> al <?echo fechaCastellano($fecha2)?>
  </div>
  <div >
...
<button type="button" class="btn btn-success" data-toggle="modal" data-target="#FiltroVendedor" class="btn btn-default">
        ...
        buttons:[ 
			{
                ...
                title: 'Totales de ventas del <?echo $fecha1?> al <?echo $fecha2?> de la sucursal',
