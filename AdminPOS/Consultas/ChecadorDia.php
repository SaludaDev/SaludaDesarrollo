...
Reloj_ChecadorV2_Salidas.Hora_Registro,Reloj_ChecadorV2.Fecha_Registro,Reloj_ChecadorV2_Salidas.Number_Empleado,Reloj_ChecadorV2.Number_Empleado,
Reloj_ChecadorV2.Hora_Registro,TIMEDIFF(Reloj_ChecadorV2_Salidas.Hora_Registro,Reloj_ChecadorV2.Hora_Registro) as totaltrabajo FROM Reloj_ChecadorV2,Reloj_ChecadorV2_Salidas WHERE DATE(Reloj_ChecadorV2.Fecha_Registro) = DATE_FORMAT(CURDATE(),'%Y-%m-%d')  AND DATE(Reloj_ChecadorV2_Salidas.Fecha_Registro) = DATE_FORMAT(CURDATE(),'%Y-%m-%d')  AND Reloj_ChecadorV2.Nombre = Reloj_ChecadorV2_Salidas.Nombre ";
