...
$sql = "SELECT Ventas_POS.Folio_Ticket,Ventas_POS.Fk_Caja,Ventas_POS.Venta_POS_ID,Ventas_POS.Identificador_tipo,Ventas_POS.Fecha_venta, 
...
AND Ventas_POS.Identificador_tipo = Servicios_POS.Servicio_ID AND MONTH(Ventas_POS.Fecha_venta)= MONTH(CURDATE()) AND YEAR(Ventas_POS.Fecha_venta)= YEAR(CURDATE())";
