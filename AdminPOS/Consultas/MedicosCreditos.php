...
<?php if($query->num_rows>0):?>
  <div class="text-center">
	...
	<table  id="MedicosCreditos" class="table table-hover">
<thead>
...
<tr>
<td > <?php echo $Categorias["ID_Med_Cred"]; ?></td>
  <td > <?php echo $Categorias["Nombre_Med"]; ?></td>
...
<a data-id="<?php echo  $Categorias["ID_Med_Cred"];?>" class="btn-editMedico dropdown-item" >Editar <i class="fas fa-edit"></i></a>
<a data-id="<?php echo $Categorias["ID_Med_Cred"];?>" class="btn-HistorialMedicos dropdown-item" >Movimientos <i class="fas fa-history" aria-hidden="true"></i></a>
...
<script>
  	$(".btn-editMedico").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludaclinicas.com/AdminPOS/Modales/EditaMedCredito.php","id="+id,function(data){
    ...
    $(".btn-HistorialMedicos").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludaclinicas.com/AdminPOS/Modales/HistorialMedicosCreditos.php","id="+id,function(data){
              $("#EditMedicos").html(data);
              $("#TituloMedicos").html("Movimientos aplicados en el área");
              $("#DiMedicos").removeClass(" modal-dialog modal-lg modal-notify modal-info");
              $("#DiMedicos").removeClass("modal-dialog  modal-notify modal-info");
              $("#DiMedicos").addClass("modal-dialog modal-xl modal-notify modal-primary");
  		});
  		$('#ModalMedicos').modal('show');
    });
  </script>
