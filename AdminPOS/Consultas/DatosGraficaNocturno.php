...
SucursalesCorre.ID_SucursalC,SucursalesCorre.Nombre_Sucursal FROM Ventas_POS,SucursalesCorre WHERE Ventas_POS.Turno='Nocturno' AND  Ventas_POS.Fk_sucursal=SucursalesCorre.ID_SucursalC AND 
