...
$(document).ready( function () {
    $('#RegistroVentasMayores').DataTable({
      "order": [[ 0, "desc" ]],
...
FROM Ventas_POS,SucursalesCorre WHERE Ventas_POS.Fecha_venta=CURDATE() AND Ventas_POS.Fk_sucursal= SucursalesCorre.ID_SucursalC GROUP BY Ventas_POS.Nombre_Prod,Ventas_POS.Fk_sucursal ORDER BY
 `SucursalesCorre`.`Nombre_Sucursal` ASC";
...
<?php if($query->num_rows>0):?>
  <div class="text-center">
	...
	<table  id="RegistroVentasMayores" class="table table-hover">
<thead>
