...
Stock_POS.Fk_Sucursal = SucursalesCorre.ID_SucursalC AND   Stock_POS.Existencias_R !=  0 AND  Stock_POS.Tipo_Servicio= Servicios_POS.Servicio_ID AND Productos_POS.ID_Prod_POS =Stock_POS.ID_Prod_POS AND
