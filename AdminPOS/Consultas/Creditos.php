...
<a data-id="<?php echo $Categorias["Folio_Credito"];?>" class="btn-edit3 dropdown-item" >Realizar ajuste <i class="fas fa-info-circle"></i></a>
...
<script>
  	$(".btn-edit").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludaclinicas.com/AdminPOS/Modales/AbonoCredito.php","id="+id,function(data){
  			$("#form-edit").html(data);
    ...
    $(".btn-edit2").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludaclinicas.com/AdminPOS/Modales/HistorialSaldos.php","id="+id,function(data){
              $("#form-edit").html(data);
  ...
  <div id="Di"class="modal-dialog modal-lg modal-notify modal-info">
      ...
      <div class="modal-header">
        ...
        <div id="Mensaje "class="alert alert-info alert-styled-left text-blue-800 content-group">
                            ...
                            Verifique los campos antes de realizar alguna acción</span>
