...
<?include_once ("Menu.php")?>
  ...
  Registro diario de uso de energia electrica <?echo $row['ID_H_O_D']?> al <?php echo FechaCastellano(date('d-m-Y H:i:s')); ?>  
  </div>
...
<script src="js/ControlEnergiaElectricoModificable.js"></script>
