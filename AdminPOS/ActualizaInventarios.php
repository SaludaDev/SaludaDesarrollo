...
<div class="col">
  ...
  <input type="number" class="form-control "  readonly name="ExistenciaPrev" id="existenciaactual" value="<? echo $Especialistas->Existencias_R; ?>" >
    ...
    <label for="exampleFormControlInput1">Cantidad de ajuste <span class="text-danger">*</span></label>
    <div class="input-group mb-3">
  <div class="input-group-prepend">  <span class="input-group-text" id="Tarjeta"><i class="fas fa-pills"></i></span>
  </div>
  <input type="number" class="form-control " oninput ="sumanuevo()" name="Recibio" id="recibio"  >
    </div><label for="pc" class="error">
    </div>
    <div class="col">
    <label for="exampleFormControlInput1">Existencia despues de ajuste <span class="text-danger">*</span></label>
    <div class="input-group mb-3">
  <div class="input-group-prepend">  <span class="input-group-text" id="Tarjeta"><i class="fas fa-pills"></i></span>
  </div>
...
<div class="col">
  ...
  <input type="number" class="form-control " min="0" oninput ="sumanuevo()" name="Recibio" id="recibioo"  >
    </div><label for="pc" class="error">
    </div>
    <div class="col">
