...
<head>
  ...
  <title>Mobilario de <?echo $row['ID_H_O_D']?> </title>
...
<div class="tab-pane fade show active" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
 ...
 Mobiliario  <?echo $row['ID_H_O_D']?> al <?php echo FechaCastellano(date('d-m-Y H:i:s')); ?>  
  </div>
...
<script src="js/ControlStockMobiliario.js"></script>

<script src="js/CambiaDeSucursalMobiliarios.js"></script>
