...
<div class="card text-center">
    ...
    <div>
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#FiltroEspecifico"
            class="btn btn-default">
            Filtrar por sucursal <i class="fas fa-clinic-medical"></i>
            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#FiltroConteoDiario" class="btn btn-default">
                Filtrar por fechas <i class="fas fa"></i>
            </button>
    </div>
    <div>
...
include("Modales/BusquedaConteoDiarioFecha.php");
  ?>
