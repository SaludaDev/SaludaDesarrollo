...
<head>
  ...
  <title>Ajustes realizados <?php echo $row['ID_H_O_D']?> </title>
...
<?php include_once ("Menu.php")?>
  ...
  Ajustes de inventarios <?php echo $row['ID_H_O_D']?> al <?php echo FechaCastellano(date('d-m-Y H:i:s')); ?>  
  </div>
 
  <div >
  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#FiltroPorSucursales" class="btn btn-default">
  Filtro por sucursal <i class="fas fa-clinic-medical"></i>
</button>
</div>
  <div >
...
<script src="js/AjustesInventariosRealizados.js"></script>
