...
<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
  ...
  <li class="nav-item">
    <a class="nav-link  active" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Medicamentos</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#PorCaducar" role="tab" aria-controls="pills-contact" aria-selected="false">Mobiliario</a>
  </li>
...
<div id="tablaProductosInventarios"></div>
  </div>
<!-- POR CADUCAR -->
...
<!-- REQUIRED SCRIPTS -->
<script src="js/ControlProductosInventario.js"></script>
