...
<html lang="es">
<head>
	<title>SERVICIOS ESPECIALIZADOS | LOGIN</title>
	<meta charset="UTF-8">
...
<script type="text/javascript" src="Consultas/ServiciosEspecialesV2.js"></script>
...
<nav class="mb-1 navbar navbar-expand-lg navbar-dark default-color" style="background-color: #2E64FE !important;">
  <a class="navbar-brand" href="#">SERVICIOS ESPECIALIZADOS  <i  class="fas fa-x-ray fa-2x fa-lgfa-2x fa-lg"></i> </a>
