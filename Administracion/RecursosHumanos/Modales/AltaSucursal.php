...
<div class="form-group">
    ...
    <input type="text" class="form-control"  name="Agrega" id="agrega"  readonly value=" <?echo $row['Nombre_Apellidos']?>">
    <input type="text" class="form-control"  name="Sistema" id="sistema"  readonly value=" <?echo $row['Nombre_rol']?>">
