...
<input  class="montoreal form-control"  type="number" id="costoventa" name="ImporteT[]" >  </div>\
    <div class="col">\
   ...
   <input   class="Cantidad form-control" onfocus="multiplicar()"  id="cantidadventa" value="1" type="number" name="CantidadTotal[]" min="1" pattern="^[0-9]+" ></div>\
    <div class="col"> \
...
$('#add_field').click (function(e) {
  ...
  <div class="col">\
   ...
   <div class="col">\
    <label for="exampleFormControlInput1">Cantidad<span class="text-danger">*</span></label>\
    <input   class="multireal form-control"  id="cantidad2"  onchange="multiplicar2() "type="number" name="CantidadTotal[]" value="1" min="1" pattern="^[0-9]+" > </div>\
...
$('#add_field2').click (function(e) {
  ...
  <input  class="Precio form-control" readonly type="number" id="descuento3"  name="DescuentoAplicado[]" ></div>\
   <div class="col">\
    <label for="exampleFormControlInput1">Cantidad<span class="text-danger">*</span></label>\
<input   class="form-control"  id="cantidad3" onchange="multiplicar3()" type="number" name="CantidadTotal[]" value="1"  min="1" pattern="^[0-9]+" > </div>\
<div class="col">\ <label for="exampleFormControlInput1">Descuento</label>\
...
$('#add_field3').click (function(e) {
  ...
  <input  class="Precio form-control" readonly type="number" id="descuento4"  name="DescuentoAplicado[]" ></div>\
   <div class="col">\
    <label for="exampleFormControlInput1">Cantidad<span class="text-danger">*</span></label>\
<input   class="form-control"  id="cantidad4" type="number" onchange="multiplicar4()" name="CantidadTotal[]" value="1" min="1" pattern="^[0-9]+" > </div>\
<div class="col">\ <label for="exampleFormControlInput1">Descuento</label>\
...
$('#add_field4').click (function(e) {
  ...
  <input  class="Precio form-control" readonly type="number" id="descuento5"  name="DescuentoAplicado[]" ></div>\
   <div class="col">\
    <label for="exampleFormControlInput1">Cantidad<span class="text-danger">*</span></label>\
<input   class="form-control"  id="cantidad5" type="number" onchange="multiplicar5()" name="CantidadTotal[]" value="1" min="1" pattern="^[0-9]+" > </div>\
<div class="col">\ <label for="exampleFormControlInput1">Descuento</label>\
...
$('#add_field5').click (function(e) {
  ...
  <input  class="Precio form-control" readonly type="number" id="descuento6"  name="DescuentoAplicado[]" ></div>\
   <div class="col">\
    <label for="exampleFormControlInput1">Cantidad<span class="text-danger">*</span></label>\
<input   class="form-control"  id="cantidad6" type="number" onchange="multiplicar6()" name="CantidadTotal[]" value="1" min="1" pattern="^[0-9]+" > </div>\
<div class="col">\ <label for="exampleFormControlInput1">Descuento</label>\
...
$('#add_field6').click (function(e) {
  ...
  <input  class="Precio form-control" readonly type="number" id="descuento7"  name="DescuentoAplicado[]" ></div>\
   <div class="col">\
    <label for="exampleFormControlInput1">Cantidad<span class="text-danger">*</span></label>\
<input   class="form-control"  id="cantidad7" type="number" onchange="multiplicar7()" name="CantidadTotal[]" value="1" min="1" pattern="^[0-9]+" > </div>\
<div class="col">\ <label for="exampleFormControlInput1">Descuento</label>\
...
$('#add_field7').click (function(e) {
  ...
  <input  class="Precio form-control" readonly type="number" id="descuento8"  name="DescuentoAplicado[]" ></div>\
   <div class="col">\
    <label for="exampleFormControlInput1">Cantidad<span class="text-danger">*</span></label>\
<input   class="form-control"  id="cantidad8" type="number" onchange="multiplicar8()" name="CantidadTotal[]" value="1" min="1" pattern="^[0-9]+" > </div>\
<div class="col">\ <label for="exampleFormControlInput1">Descuento</label>\
...
$('#add_field8').click (function(e) {
  ...
  <input  class="Precio form-control" readonly type="number" id="descuento9"  name="DescuentoAplicado[]" ></div>\
   <div class="col">\
    <label for="exampleFormControlInput1">Cantidad<span class="text-danger">*</span></label>\
<input   class="form-control"  id="cantidad9" type="number" onchange="multiplicar9()" name="CantidadTotal[]" value="1" min="1" pattern="^[0-9]+" > </div>\
<div class="col">\ <label for="exampleFormControlInput1">Descuento</label>\
...
$('#add_field9').click (function(e) {
  ...
  <input  class="Precio form-control" readonly type="number" id="descuento10"  name="DescuentoAplicado[]" ></div>\
   <div class="col">\
    <label for="exampleFormControlInput1">Cantidad<span class="text-danger">*</span></label>\
<input   class="form-control"  id="cantidad10" type="number" onchange="multiplicar10()" name="CantidadTotal[]" value="1" min="1" pattern="^[0-9]+" > </div>\
<div class="col">\ <label for="exampleFormControlInput1">Descuento</label>\
...
var campos_max11        = 1;   //max de 10 campos
var x11 = 0;
$('#add_field11').click (function(e) {
        e.preventDefault();     //prevenir novos clicks
        if (x11< campos_max11) {
                $('#parte11').append('<div>\
                <a hidden class="btn btn-warning btn-sm" id="remover_campo11"><i class="fas fa-minus-circle"></i></a>\
              <div class="row">\
    <div class="col">\
    <label for="exampleFormControlInput1">Codigo barras <span class="text-danger">*</span></label>\
    <input class="form-control" value="Publico General" hidden type="text" id="cliente11" name="cliente[]" />\
    <input class="form-control"  hidden type="text" id="fkid11" name="pro_FKID[]"/>\
    <input class="form-control"   hidden type="text" id="clavad11" name="pro_clavad[]"/>\
    <input class="form-control"  hidden type="text" id="identificadortip11" name="IdentificadorTip[]"/>\
    <input type="text" class="form-control " readonly id="codbarras11" name="CodBarras[]"  >\
</div>\
    <div class="col">\
    <label for="exampleFormControlInput1">Producto <span class="text-danger">*</span></label>\
  <textarea class="form-control" readonly id="nombreprod11"name="NombreProd[]" rows="3"></textarea>\
    </div>\
  <input type="text" class="form-control" readonly type="text" hidden id="lote11" name="pro_lote[]" placeholder="Ingrese minimo de existencia" aria-describedby="basic-addon1" >\
    <div class="col">\
    <label for="exampleFormControlInput1">Costo venta<span class="text-danger">*</span></label>\
    <input  class="form-control" type="number" readonly id="precioprod11"  name="pro_cantidad[]" > </div>\
    <div class="col">\
    <label for="exampleFormControlInput1">Importe<span class="text-danger">*</span></label>\
  <input  class="montoreal form-control" readonly type="number" id="costoventa11" name="ImporteT[]" > </div>\
  <div class="col">\
    <label for="exampleFormControlInput1">Descuento<span class="text-danger">*</span></label>\
  <input  class="Precio form-control" readonly type="number" id="descuento11"  name="DescuentoAplicado[]" ></div>\
   <div class="col">\
    <label for="exampleFormControlInput1">Cantidad<span class="text-danger">*</span></label>\
<input   class="form-control"  id="cantidad11" type="number" onchange="multiplicar11()" name="CantidadTotal[]" value="1" min="1" pattern="^[0-9]+" > </div>\
<div class="col">\ <label for="exampleFormControlInput1">Descuento</label>\
    <a data-toggle="modal" data-target="#Descuento11detalles" class="btn btn-primary btn-sm "><i class="fas fa-percent"></i></a></div>\
    <div class="col"> \
    <label for="exampleFormControlInput1">Remover</label>\
    <a id="remueve9" onclick="remover11();"class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>\
    </div>\
<input type="text" hidden class="form-control "  name="Sucursaleventas[]"readonly value="<?php echo $row['Fk_Sucursal']?>">\
<input type="text"hidden class="form-control " name="TurnoCaja[]" readonly value="<?php echo $ValorCaja['Turno']?>" >\
<input type="text" class="form-control " hidden name="Descuento[]" readonly value="0.00" >\
...
<input type="text"  hidden class="form-control "  name="Sistema[]" readonly value="Ventas" >\
<input type="text" class="form-control " hidden id="valcaja"name="CajaSucursal[]" readonly value="<?php echo $ValorCaja["ID_Caja"];?>" >\
<input type="text" class="form-control " hidden id="formapago11"name="FormaPago[]" readonly  >\
<input type="text" hidden class="form-control " name="Vendedor[]" readonly value="<?php echo $row['Nombre_Apellidos']?>" >\
</div>');
                x11++;
        }
...
// Remover o div anterior
$('#parte11').on("click","#remover_campo1",function(e) {
        e.preventDefault();
        $(this).parent('div').remove();
        x8--;
        $("#FiltrarContenido11").hide()
