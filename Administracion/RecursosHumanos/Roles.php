...
<head>
  ...
  <title>ROLES O PUESTOS DE  <?echo $row['ID_H_O_D']?> </title>
...
<div class="card text-center">
  ...
  Roles/Puestos vigentes al <?php echo FechaCastellano(date('d-m-Y H:i:s')); ?>  
  </div>
  
  <div >
  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#Altarol" class="btn btn-default">
  Añadir nuevo Rol/Puesto <i class="fas fa-user-plus"></i>
</button>
</div>
</div>
...
<!-- REQUIRED SCRIPTS -->
<script src="js/CargaRoles.js"></script>
<script src="js/CargaRolesBajas.js"></script>
