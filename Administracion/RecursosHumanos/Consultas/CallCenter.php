...
Personal_Agenda.Correo_Electronico,Personal_Agenda.Telefono,Personal_Agenda.Password,Personal_Agenda.Biometrico,
...
<a data-id="<?php echo $Usuarios["PersonalAgenda_ID"];?>" class="btn-edit2 dropdown-item" >Editar datos <i class="fas fa-pencil-alt"></i></a>
  ...
  idempleado=<?php echo $Usuarios["PersonalAgenda_ID"]; ?>&&nombreempleado=<?php echo $Usuarios["Nombre_Apellidos"]; ?>&&sucursalnombre=Oficinas&&puesto=CallCenter" target="Blank_">Capturar datos biometricos <i class="fas fa-fingerprint"></i></a>
