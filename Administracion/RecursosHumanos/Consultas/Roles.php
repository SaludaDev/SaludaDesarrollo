...
<?php endif;?>
  ...
  <script>
  	$(".btn-edit").click(function(){
  		id = $(this).data("id");
  		$.post("https://www.somosgrupoe.com/Administracion/RecursosHumanos/Modales/DescontinuaRol.php","id="+id,function(data){
  			$("#form-edit").html(data);
    ...
    $(".btn-edit2").click(function(){
  		id = $(this).data("id");
  		$.post("https://www.somosgrupoe.com/Administracion/RecursosHumanos/Modales/Editarol.php","id="+id,function(data){
              $("#form-edit").html(data);
