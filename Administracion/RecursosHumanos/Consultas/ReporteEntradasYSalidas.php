    ...
    $('#SalidaEmpleados').DataTable({
        ...
        buttons:[ 
      {
        ...
        titleAttr: 'Exportar a Excel',
                title: 'Entradas y Salidas del personal ',
...
$user_id=null;
$sql1="SELECT * FROM `Reloj_ChecadorV2` WHERE DATE(Fecha_Registro2) = DATE_FORMAT(CURDATE(),'%Y-%m-%d')";
$sql2="SELECT * FROM `Reloj_ChecadorV2_Salidas` WHERE DATE(Fecha_Registro) = DATE_FORMAT(CURDATE(),'%Y-%m-%d')";
...
<tr>
  ...
  <td><?php echo FechaCastellano($Usuarios["Fecha_Registro2"]); ?></td>
