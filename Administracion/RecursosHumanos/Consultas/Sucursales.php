...
<a data-id="<?php echo  $Usuarios["ID_SucursalC"];?>" class="btn-edit dropdown-item" >Detalles <i class="fas fa-address-card"></i></a>
<a data-id="<?php echo $Usuarios["ID_SucursalC"];?>" class="btn-edit2 dropdown-item" >Editar datos <i class="fas fa-pencil-alt"></i></a>
<a data-id="<?php echo $Usuarios["ID_SucursalC"];?>" class="btn-Historial dropdown-item" >Historial <i class="fas fa-pencil-alt"></i></a>
...
<?php endif;?>
  ...
  <script>
  	$(".btn-edit").click(function(){
  		id = $(this).data("id");
  		$.post("https://www.somosgrupoe.com/Administracion/RecursosHumanos/Modales/DetallesSucursal.php","id="+id,function(data){
  			$("#form-edit").html(data);
          $("#Titulo").html("Detalles Sucursal");
    ...
    $(".btn-edit2").click(function(){
  		id = $(this).data("id");
  		$.post("https://www.somosgrupoe.com/Administracion/RecursosHumanos/Modales/EditaSucursal.php","id="+id,function(data){
              $("#form-edit").html(data);
    ...
    $(".btn-Historial").click(function(){
  		id = $(this).data("id");
  		$.post("https://www.somosgrupoe.com/Administracion/RecursosHumanos/Modales/HistorialSucursales.php","id="+id,function(data){
              $("#form-edit").html(data);
