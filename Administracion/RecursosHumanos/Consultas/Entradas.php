...
$(document).ready( function () {
    $('#IngresoEmpleados').DataTable({
      ...
      "lengthMenu": [[25,50, 150, 200, -1], [25,50, 150, 200, "Todos"]],   
        ...
        title: 'Reloj checador de sucursales doctor consulta del día <?echo $fcha;?>',
...
$user_id=null;
$sql1="SELECT * FROM `Reloj_Checador` WHERE DATE(Fecha_Registro) = DATE_FORMAT(CURDATE(),'%Y-%m-%d')";
