...
<div class="card text-center">
  ...
  Empleados de farmacia vigentes al <?php echo FechaCastellano(date('d-m-Y H:i:s')); ?>  
  </div>
...
<?
  ...
  include ("Modales/AltaEmpleadosPOS.php");
...
<!-- REQUIRED SCRIPTS -->
<script src="js/ControlEmpleadosPOS.js"></script>
<script src="js/ControlBajaEmpleadosPOS.js"></script>
<script src="js/AltaEmpleadosPOS.js"></script>
