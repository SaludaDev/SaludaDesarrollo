$("document").ready(function ($) {
  ...
  function submitForm() {
    $.ajax({
      type: "POST",
      url: "Consultas/EditProductosGeneralVersion2.php",
      ...
      success: function (dataResult) {
        ...
        if (dataResult.statusCode == 200) {
          ...
          $("#EnviarDatosStock").trigger("click");

          $.ajax({
            type: "POST",
            url: "Consultas/EditStock.php",
            ...
            success: function (dataResult) {
              ...
              if (dataResult.statusCode == 400) {
                ...
                $("#editModalProductosG").removeClass("in");
                $(".modal-backdrop").remove();
                $("#editModalProductosG").hide();
