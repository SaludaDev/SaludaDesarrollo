$('document').ready(function ($) {
    ...
    $("#ActualizaPresentaciones").validate({
        rules: {


            ActNombrepresentacion: {
                required: true,
            },
            ActSiglaspresentacion:{
                required: true,
            },
           ActVigenciaPre: {
                required: true,
    ...
    function submitForm() {
        ...
        $.ajax({
            type: 'POST',
            url: "Consultas/ActualizaPresentaciones.php",
            data: $('#ActualizaPresentaciones').serialize(),
            cache: false,
            beforeSend: function () {
                $("#success").fadeOut();
