$('document').ready(function($){
    ...
    function submitForm() {		
        ...
        var vigenciamarcas = $('#vigenciamarcas').val();
        var usuariom = $('#usuariom').val();
        var vigenciaestm = $('#vigenciaestm').val();
     var empresam = $('#empresam').val();
      
          var sistemam = $('#sistemam').val();
       
		$.ajax({				
			type : 'POST',
            url: "Consultas/AltaMarcas.php",
			data: {
           
             nombremarca:nombremarca,
             vigenciamarcas:vigenciamarcas,
              usuariom:usuariom,
              vigenciaestm:vigenciaestm,
            ...
            success: function(dataResult){
                ...
                setTimeout(function(){ 
                    $("#submit_registro").html("Guardar <i class='fas fa-save'></i>");
                     ...
                     $("#AgregaMarcaNueva")[0].reset();
                     $("#AltaMarcas").removeClass("in");
