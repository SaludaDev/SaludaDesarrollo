$('document').ready(function ($) {
    ...
    function submitForm() {
      ...
      $.ajax({
        type: 'POST',
        url: "Consultas/AgregaservicioNuevo.php",
        data: $('#AgregaservicioNueva').serialize(),
        cache: false,
        beforeSend: function () {
        ...
        success: function (dataResult) {
          ...
          if (dataResult.statusCode == 250) {
            ...
            $("#AgregaservicioNueva")[0].reset();
            $("#AltadeServicios").removeClass("in");
            $(".modal-backdrop").remove();
            $("#AltadeServicios").hide();
