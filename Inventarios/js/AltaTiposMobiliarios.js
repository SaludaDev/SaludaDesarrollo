...
VigenciaMobi: {
  required: true,        
    ...
    function submitForm() {	
        ...
        $.ajax({				
            type : 'POST',
            url: "Consultas/AltaNuevoTipMobiliario.php",
            data: $('#AgregaTipoMobiliario').serialize(),
            cache: false,
            beforeSend: function(){	
      ...
      success: function(dataResult){
        ...
        setTimeout(function(){ 
            $("#submit_registro").html("Guardar <i class='fas fa-save'></i>");
             ...
             $("#AgregaTipoMobiliario")[0].reset();
             $("#AltaTiposMobiliario").removeClass("in");
             $(".modal-backdrop").remove();
             $("#AltaTiposMobiliario").hide();
