$('document').ready(function ($) {
    ...
    function submitForm() {
        ...
        $.ajax({
            type: 'POST',
            url: "Consultas/EliminaProcedimiento.php",
            data: $('#EliminaProcedimiento').serialize(),
            cache: false,
            beforeSend: function () {
                $("#success").fadeOut();
            ...
            success: function (dataResult) {
                ...
                if (dataResult.statusCode == 200) {
                    ...
                    CargaProcedimientos();
                    $("#editModalStockSucursalesA").removeClass("in");
                    $(".modal-backdrop").remove();
                    $("#editModalStockSucursalesA").hide();


                    $('#ExitoEliminado').modal('toggle');
                    setTimeout(function () {
                        $('#ExitoEliminado').modal('hide')
                    }, 3000); // abrir
