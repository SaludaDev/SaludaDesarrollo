$('document').ready(function($){
    ...
    $("#AgregaPresentacionNueva").validate({
		rules: {
    ...
    function submitForm() {		
        ...
        var vigenciapresentacion= $('#vigenciapresentacion').val();
        var usuariop = $('#usuariop').val();
        var vigenciaestp = $('#vigenciaestp').val();
     var empresap = $('#empresap').val();
      
          var sistemap = $('#sistemap').val();
       
		$.ajax({				
			type : 'POST',
            url: "Consultas/AltaPresentaciones.php",
			data: {
           
             nombrepresentacion:nombrepresentacion,
             siglas:siglas,
             vigenciapresentacion:vigenciapresentacion,
              usuariop:usuariop,
              vigenciaestp:vigenciaestp,
