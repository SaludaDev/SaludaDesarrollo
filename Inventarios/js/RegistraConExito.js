$('document').ready(function ($) {
    ...
    $("#ProblemaConTraspasoRealizado").validate({
      rules: {
    ...
    function submitForm() {
      ...
      $.ajax({
        type: 'POST',
        url: "Consultas/RegistraConExito.php",
        data: $('#ProblemaConTraspasoRealizado').serialize(),
        cache: false,
        beforeSend: function () {
        ...
        success: function (dataResult) {
          ...
          if (dataResult.statusCode == 250) {
            ...
            $("#ProblemaConTraspasoRealizado")[0].reset();
         
          
            $("#EnviarActualizaciondestock").trigger("click");
