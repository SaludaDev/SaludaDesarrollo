...
<div class="form-group">
  ...
  <input type="text" class="form-control " disabled readonly value="<? echo $Especialistas->Pprod_ID; ?>">
    </div>
    </div>
  ...
  <input type="text" class="form-control "  readonly value="<? echo $Especialistas->Nom_Presentacion; ?>" aria-describedby="basic-addon1" maxlength="60">            
</div></div></div>
...
<div class="table-responsive">
  ...
  <tbody>
    <tr>
<td>
<button id="VigenciaBDPre" class="btn btn-default btn-sm" style=<? echo $Especialistas->Cod_Estado; ?>><? echo $Especialistas->Estado; ?></button> 
   </td>
    </tr>
