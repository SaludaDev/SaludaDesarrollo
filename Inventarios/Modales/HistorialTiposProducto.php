...
$(document).ready( function () {
    var printCounter = 0;
    $('#MovimientosTiposDeProductos').DataTable({
      "order": [[ 0, "desc" ]],
          ...
          buttons:[ 
			{
                ...
                title: 'Movimientos  de tipos de productos',
...
$user_id=null;
$sql1= "SELECT * FROM TipProd_POS_Audita WHERE ID_H_O_D='".$row['ID_H_O_D']."' AND Tip_Prod_ID = ".$_POST["id"];
...
<?php if($query->num_rows>0):?>
  <div class="text-center">
	...
	<table  id="MovimientosTiposDeProductos" class="table table-hover">
<thead>
...
<tr>
<td > <?php echo $Categorias["ID_Audita_TipoProd"]; ?></td>
  <td > <?php echo $Categorias["Tip_Prod_ID"]; ?></td>
  <td > <?php echo $Categorias["Nom_Tipo_Prod"]; ?></td>
