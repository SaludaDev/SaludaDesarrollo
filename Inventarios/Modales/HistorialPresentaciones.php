          ...
          buttons:[ 
			{
                ...
                title: 'Movimientos  de promociones ',
...
$user_id=null;
$sql1= "SELECT * FROM `Presentacion_Prod_POS_Updates` where ID_H_O_D='".$row['ID_H_O_D']."' AND 
Pprod_ID = ".$_POST["id"];
...
<?php if($query->num_rows>0):?>
  <div class="text-center">
	...
	<table  id="MovimientosPromos" class="table table-hover">
<thead>
...
<tr>
<td > <?php echo $Categorias["ID_Update_Pre"]; ?></td>
  <td > <?php echo $Categorias["Pprod_ID"]; ?></td>
  <td > <?php echo $Categorias["Nom_Presentacion"]; ?></td>
