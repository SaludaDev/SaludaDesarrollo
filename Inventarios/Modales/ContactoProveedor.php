...
<? if($Especialidades!=null):?>
  ...
  <div class="row">
    <div class="col"> 
      <label for="exampleFormControlInput1">Nombre proveedor</label> <br>
      <i class="fas fa-id-card-alt"></i> <br>
        <? echo $Especialidades->Nombre_Proveedor; ?>  </div>
    <div class="col"> <label for="exampleFormControlInput1">Telefono</label> <br>
    <i class="fas fa-phone"></i> <br>
      <a href="tel:+<? echo $Especialidades->Numero_Contacto; ?>"> <? echo $Especialidades->Numero_Contacto; ?> </a>
    </div>
    <div class="w-100"></div> <br>
    <div class="col"> <label for="exampleFormControlInput1">Whatsapp</label> <br>
    <i class="fab fa-whatsapp"></i> <br>
      <a href="https://api.whatsapp.com/send/?phone=%2B52<? echo $Especialidades->Telefono; ?>"> <? echo $Especialidades->Numero_Contacto; ?> </a>  </div>
