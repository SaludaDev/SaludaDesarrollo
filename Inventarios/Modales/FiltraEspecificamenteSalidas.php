<div class="modal fade bd-example-modal-xl" id="FiltroEspecificoFechaSalidas" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog  modal-notify modal-success">
    <div class="modal-content">
    
    <div class="text-center">
    <div class="modal-header">
         <p class="heading lead">Filtrado de registros por fecha<i class="fas fa-credit-card"></i></p>
 ...
 <form  method="POST" action="BusquedaFechasSalidas">
