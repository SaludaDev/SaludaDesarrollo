<div class="modal fade bd-example-modal-xl" id="FiltroConteoDiario" tabindex="-1" role="dialog"
    ...
    <div class="modal-content">
      ...
      <div class="text-center">
        <div class="modal-header">
          <p class="heading lead">Busqueda de conteos diarios por fechas<i class="fas fa-credit-card"></i></p>
        ...
        <div class="modal-body">
          ...
          <form method="POST" action="https://controlfarmacia.com/AdminPOS/InventarioRapidoResultado">
