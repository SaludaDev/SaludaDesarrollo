      ...
      <div class="modal fade bd-example-modal-xl" id="AltaNTipCred" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
 ...
 <form action="javascript:void(0)" method="post" id="AgregaTipoCreditoNuevo">
  ...
  <input type="text" class="form-control " disabled readonly maxlength="60">
    ...
    <label for="exampleFormControlInput1">Nombre de credito <span class="text-danger">*</span></label>
     <div class="input-group mb-3">
  <div class="input-group-prepend">
  
    <span class="input-group-text" id="Tarjeta"><i class="fas fa-file-signature"></i></span>
  </div>
  <input type="text" class="form-control " name="NombreCredito" id="nombrecredito" placeholder="Por ejemplo: Antibiotico" aria-describedby="basic-addon1" maxlength="60">            
</div>
<label for="exampleFormControlInput1">Costo total <span class="text-danger">*</span></label>
  ...
  <input type="text" class="form-control " name="Costo" id="costo" placeholder="Por ejemplo: Antibiotico" aria-describedby="basic-addon1" maxlength="60">            
</div>
