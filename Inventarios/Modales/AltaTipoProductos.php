<div class="modal fade bd-example-modal-xl" id="AltaTiposProductos" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog  modal-notify modal-success">
        <div class="modal-content">

            <div class="text-center">
                <div class="modal-header">
                    <p class="heading lead">Añadiendo nuevo tipo de producto</p>
                ...
                <div class="modal-body">
                    ...
                    <form action="javascript:void(0)" method="post" id="AgregaTipoProductoNuevo">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control " name="NombreTipoProd" id="nombretipoprod" placeholder="Por ejemplo: Antibiotico" aria-describedby="basic-addon1" maxlength="60">
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select name="VigenciaProdT" class="form-control" id="Vigenciatipoprod" onchange="TipoVigenciaTiposProductos();">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th scope="col" style="background-color: #00c851 !important;">Vigencia de tipo de producto</th>
                        ...
                        <input type="text" class="form-control " hidden  readonly id="usuariom" name="UsuarioTP"  readonly value="<?echo $row['Nombre_Apellidos']?>">
                        <input type="text" class="form-control " hidden  readonly name="VigenciaEstPP" id="vigenciatipoprodd">
                        <input type="text" class="form-control " hidden  readonly id="sistemam" name="SistemaPP" readonly value="POS <?echo $row['Nombre_rol']?>">
                        <input type="text" class="form-control " hidden id="empresam" name="EmpresaPP" readonly value="<?echo $row['ID_H_O_D']?>">
                        <div>
...
<script type="text/javascript">
    function TipoVigenciaTiposProductos() {
        ...
        var combo = document.getElementById("Vigenciatipoprod");
        var selected = combo.options[combo.selectedIndex].text;
        $("#vigenciatipoprodd").val(selected);
    }
    ...
    $(function() {
        ...
        $("#Vigenciatipoprod").on('change', function() {
