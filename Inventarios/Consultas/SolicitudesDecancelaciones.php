...
Ventas_POS,SucursalesCorre WHERE Ventas_POS.Fk_sucursal= SucursalesCorre.ID_SucursalC AND Ventas_POS.Estatus='Cancelacion' AND Ventas_POS.ID_H_O_D ='".$row['ID_H_O_D']."'";
...
<a data-id="<?php echo $Usuarios["Folio_Ticket"];?>" class="btn-Autorizar dropdown-item" >Autorizar cancelación <i class="fas fa-history" aria-hidden="true"></i></a>
<a data-id="<?php echo $Usuarios["Folio_Ticket"];?>" class="btn-Rechazar dropdown-item" >Rechazar cancelación <i class="fas fa-history" aria-hidden="true"></i></a> 
</div>
<!-- Basic dropdown -->
	 </td>
...
$(".btn-Autorizar").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/AdminPOS/Modales/ConfirmaCancelacionTicket.php","id="+id,function(data){
  			$("#form-edit").html(data);
  ...
  $(".btn-Rechazar").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/AdminPOS/Modales/ConfirmaRechazoTicket.php","id="+id,function(data){
  			$("#form-edit").html(data);
          $("#Titulo").html("Medios disponibles para contactar al proveedor");
              $("#Di").removeClass("modal-dialog modal-lg modal-notify modal-info");
              $("#Di").removeClass("modal-dialog modal-lg modal-notify modal-danger");
