...
$(document).ready( function () {
    $('#TotalesGeneralesSinCortes').DataTable({
      "order": [[ 0, "desc" ]],
...
$user_id=null;
$sql1="SELECT Cajas_POS.ID_Caja,Cajas_POS.Fecha_Apertura,Cajas_POS.Cantidad_Fondo,Cajas_POS.Sucursal,Cajas_POS.Empleado,Cajas_POS.ID_H_O_D,
SucursalesCorre.ID_SucursalC,SucursalesCorre.Nombre_Sucursal ,SUM(Cajas_POS.Valor_Total_Caja - Cajas_POS.Cantidad_Fondo) as 
TotalDeCajas FROM Cajas_POS,SucursalesCorre WHERE Cajas_POS.Sucursal = SucursalesCorre.ID_SucursalC  AND 
 Cajas_POS.ID_H_O_D  ='".$row['ID_H_O_D']."'  GROUP BY Fecha_Apertura";
...
<?php if($query->num_rows>0):?>
  <div class="text-center">
	...
	<table  id="TotalesGeneralesSinCortes" class="table table-hover">
<thead>
