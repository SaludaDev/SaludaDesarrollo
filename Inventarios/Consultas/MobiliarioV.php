...
$user_id=null;
$sql1="SELECT * FROM Proveedores_POS WHERE ID_H_O_D='".$row['ID_H_O_D']."' ORDER BY `ID_Proveedor` DESC";
...
<?php if($query->num_rows>0):?>
  <div class="text-center">
	...
	<table  id="MobiliarioVigente" class="table table-hover">
<thead>
