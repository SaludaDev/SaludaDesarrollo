...
<td > <?php echo $Usuarios["ID_SucursalC"]; ?></td>
    ...
    <td><a type="button" class="btn btn-success" href="https://api.whatsapp.com/send?phone=+52<?php echo $Usuarios["Telefono"]; ?>" target="Blank_"><i class="fa-brands fa-whatsapp"></i></a></td>
    <td>
		 <!-- Basic dropdown -->
...
<?php endif;?>
  ...
  <script>
    ...
    $(".btn-edit2").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludaclinicas.com/AdminPOS/Modales/EditaSucursal.php","id="+id,function(data){
              $("#form-edit").html(data);
    ...
    $(".btn-Historial").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludaclinicas.com/AdminPOS/Modales/HistorialSucursales.php","id="+id,function(data){
              $("#form-edit").html(data);
