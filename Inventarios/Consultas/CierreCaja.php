...
$ID_H_O_D=  $conn -> real_escape_string(htmlentities(strip_tags(Trim($_POST['Empresa']))));   
    ...
    $row = mysqli_fetch_assoc($resultset);	
        ...
        if($row['Fk_Caja']==$Fk_Caja AND $row['Empleado']==$Empleado AND $row['Sucursal']==$Sucursal AND $row['ID_H_O_D']==$ID_H_O_D ){				
            ...
            $sql = "INSERT INTO `Cortes_Cajas_POS`(`Fk_Caja`, `Empleado`, `Sucursal`,`Ticket_Inicial`,`Ticket_Final`,`TotalTickets`,`D1000`, `D500`, `D200`, `D100`, `D50`, `D20`, `D10`, `D5`, `D2`, `D1`, `D50C`, 
            `D20C`, `D10C`, `Valor_Total_Caja`, `Sistema`, `ID_H_O_D`) 
            VALUES ('$Fk_Caja', '$Empleado', '$Sucursal','$Ticket_Inicial','$Ticket_Final','$TotalTickets','$D1000', '$D500', '$D200', '$D100', '$D50', '$D20', '$D10', '$D5', '$D2', '$D1', '$D50C', 
            '$D20C', '$D10C', '$Valor_Total_Caja', '$Sistema', '$ID_H_O_D')";
