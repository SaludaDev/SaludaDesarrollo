...
AND Ventas_POS.Fk_sucursal='".$row['Fk_Sucursal']."' AND Servicios_POS.Servicio_ID=Ventas_POS.Identificador_tipo AND Ventas_POS.Identificador_tipo=24 GROUP BY Ventas_POS.Nombre_Prod,Ventas_POS.Cod_Barra  ";
