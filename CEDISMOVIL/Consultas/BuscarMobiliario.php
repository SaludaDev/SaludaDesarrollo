...
$(document).ready( function () {
    $('#MobiliariosPoragregarpronto').DataTable({
      "order": [[ 0, "desc" ]],
      "lengthMenu": [[1 -1], [1,]],   
      "language": {
...
<?php if($query->num_rows>0):?>
  <div class="text-center">
	...
	<table  id="MobiliariosPoragregarpronto" class="table table-hover">
<thead>
...
<a data-id="<?php echo  $Usuarios["ID_Inv_Clic"];?>" class="btn-Asignacion  dropdown-item" >Asignar mobiliario <i class="fas fa-paste"></i></a>
...
<?php endif;?>
  ...
  <script>
  	$(".btn-Asignacion").click(function(){
          ...
          $("#TituloMobiliarios").html("Asignacion de MobiliariosPoragregarpronto en otras sucursales");
  ...
  <div id="DiMobiliariosV"class="modal-dialog modal-lg modal-notify modal-info">
      ...
      <div class="modal-header">
        ...
        <div id="MensajeMobiliariosPoragregarprontoG"class="alert alert-info alert-styled-left text-blue-800 content-group">
