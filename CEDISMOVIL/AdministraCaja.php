...
<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
  ...
  <li class="nav-item">
    <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Estado de cajas del <?php echo FechaCastellano(date('d-m-Y H:i:s')); ?>  </a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="CajasSincroniza" data-toggle="pill" href="#sincroniza" role="tab" aria-controls="pills-profile" aria-selected="false">Estado de cajas sincronizadas del <?php echo FechaCastellano(date('d-m-Y H:i:s')); ?>  </a>
  </li>
</ul>
...
<div class="tab-pane fade" id="sincroniza" role="tabpanel" aria-labelledby="pills-profile-tab"><div class="card text-center">
  <div class="card-header" style="background-color:#2b73bb !important;color: white;">
Cajas sincronizadas de <?echo $row['ID_H_O_D']?> 
  </div>
...
<div id="CajasSincronizadas"></div></div>
</div>
...
<script src="js/CajasSincronizadas.js"></script>
