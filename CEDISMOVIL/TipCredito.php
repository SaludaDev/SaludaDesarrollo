...
<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
  ...
  <li class="nav-item">
    <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Médicos</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">Áreas</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#Promos" role="tab" aria-controls="pills-contact" aria-selected="false">Promociones</a>
  </li>
</ul>
...
<div class="card text-center">
  ...
  Añadir nuevo tipo de tratamiento <i class="fas fa-credit-card"></i>
</button>
</div>
</div>
...
<div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
  ...
  <div >
  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#AltaMedicosCreditos" class="btn btn-default">
  Añadir nuevo médico  <i class="far fa-plus-square"></i>
</button>
</div>

</div>
<div id="TableMedicosCreditos"></div>
  </div>
<!-- Medicos Fin -->
...
<div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
  ...
  <div >
  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#AltaAreasCreditos" class="btn btn-default">
  Añadir nueva área <i class="far fa-plus-square"></i>
</button>
</div>

</div>
<div id="TableAreasCreditos"></div>
  </div>
