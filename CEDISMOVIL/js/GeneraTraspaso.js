$('document').ready(function ($) {
    ...
    $("#GeneraTraspasoProductos").validate({
      rules: {
      ...
      messages: { 
        ...
        SucursalDestino: {
          required: "<i class='fas fa-exclamation-triangle' style='color:red'></i> Debes elegir una sucursal para traspasar el producto",
  
        },
        FechaAprox: {
          required: "<i class='fas fa-exclamation-triangle' style='color:red'></i> Debes elegir una fecha aproximada",
    ...
    function submitForm() {
      ...
      $.ajax({
        type: 'POST',
        url: "Consultas/GeneraListaTraspaso.php",
        data: $('#GeneraTraspasoProductos').serialize(),
        cache: false,
        beforeSend: function () {
        ...
        success: function (dataResult) {
          ...
          if (dataResult.statusCode == 250) {
            ...
            $("#GeneraTraspasoProductos")[0].reset();
            ...
            setTimeout(' window.location.href = "https://controlfarmacia.com/CEDISMOVIL/StockSucursalesTraspasos"; ',2000);
