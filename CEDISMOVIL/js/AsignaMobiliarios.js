$('document').ready(function($){
    ...
    function submitForm() {	
        ...
        $.ajax({				
            type : 'POST',
            url: "Consultas/AsignacionMobiliarios.php",
            data: $('#AsignaMobiliarioSuc').serialize(),
            cache: false,
            beforeSend: function(){	
      ...
      success: function(dataResult){
        ...
        setTimeout(function(){ 
            $("#submit_registro").html("Guardar <i class='fas fa-save'></i>");
             ...
             $("#AsignaMobiliarioSuc")[0].reset();
             $("#editModalMobiliariosV").removeClass("in");
             $(".modal-backdrop").remove();
             $("#editModalMobiliariosV").hide();
