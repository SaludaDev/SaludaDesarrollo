$('document').ready(function($){
    ...
    $("#AgregaTipoCreditoNuevo").validate({
		rules: {
    ...
    function submitForm() {	
        ...
        $.ajax({				
            type : 'POST',
            url: "Consultas/AltaTipoCreditos.php",
            data: $('#AgregaTipoCreditoNuevo').serialize(),
            cache: false,
            beforeSend: function(){	
      ...
      success: function(dataResult){
        ...
        setTimeout(function(){ 
            $("#submit_registro").html("Guardar <i class='fas fa-save'></i>");
             ...
             $("#AgregaTipoCreditoNuevo")[0].reset();
             $("#AltaNTipCred").removeClass("in");
