$('document').ready(function($){
    ...
    function submitForm() {	
        ...
        $.ajax({				
            type : 'POST',
            url: "Consultas/AltaAreasCreditos.php",
            data: $('#AgregaAreCreditos').serialize(),
            cache: false,
            beforeSend: function(){	
      ...
      success: function(dataResult){
        ...
        setTimeout(function(){ 
            $("#submit_registro").html("Guardar <i class='fas fa-save'></i>");
             ...
             $("#AgregaAreCreditos")[0].reset();
             $("#AltaAreasCreditos").removeClass("in");
             $(".modal-backdrop").remove();
             $("#AltaAreasCreditos").hide();
