...
TotalDeCajas FROM Cajas_POS,SucursalesCorre WHERE Cajas_POS.Sucursal = SucursalesCorre.ID_SucursalC AND  Cajas_POS.ID_H_O_D  ='".$row['ID_H_O_D']."'  GROUP BY Fecha_Apertura ";
