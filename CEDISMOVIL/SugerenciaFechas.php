...
SucursalesCorre.Nombre_Sucursal,Servicios_POS.Servicio_ID,Servicios_POS.Nom_Serv FROM Ventas_POS,SucursalesCorre,Servicios_POS 
 WHERE Ventas_POS.Fecha_venta BETWEEN '$fecha1' AND '$fecha2'  AND Ventas_POS.Fk_sucursal= SucursalesCorre.ID_SucursalC AND Ventas_POS.Fk_sucursal='$IdBusqueda' 
        ...
        buttons:[ 
			{
                ...
                title: 'registro de ventas del <?echo $fecha1?> al <?echo $fecha2?> de la sucursal <?echo  $row['Nombre_Sucursal']?>',
