...
<tr>
    ...
    <td> <a class="btn btn-success"  href="https://api.whatsapp.com/send?phone=+52<?php echo $Usuarios["Telefono"]; ?>&text=Hola, <?php echo $Usuarios["Nombres_Apellidos"]; ?> ! Te contactamos de las clínicas *Doctor consulta* para la confirmación de su cita de revaloracion agendada el día *<?php echo fechaCastellano($Usuarios["Fecha"]); ?>* en turno *<?php echo $Usuarios["Turno"]; ?>* en nuestra clínica de <?php echo $Usuarios["Nombre_Sucursal"]; ?>. Esperamos de su confirmación ☺️" target="_blank"><span class="fab fa-whatsapp"></span><span class="hidden-xs"></span></a></td>
    <td>
		 <!-- Basic dropdown -->
...
<?php endif;?>
  ...
  <script>
    ...
    $(".btn-Cancela").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlconsulta.com/Medicos/CancelaCitaRev.php","id="+id,function(data){
    ...
    $(".btn-Asiste").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlconsulta.com/Medicos/AsistenciaPacienteRevaloracion.php","id="+id,function(data){
              $("#form-editExt").html(data);
